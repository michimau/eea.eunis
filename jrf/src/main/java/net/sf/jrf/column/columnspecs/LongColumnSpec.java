...
import net.sf.jrf.join.joincolumns.LongJoinColumn;

import net.sf.jrf.sql.*;

/** This subclass of AbstractColumnSpec does Long-specific things. */
public class LongColumnSpec
     extends NumericColumnSpec
{

    /* ===============  Static Variables  =============== */
    protected final static Class s_class = Long.class;


    /* ===============  Constructors  =============== */
    /** Default constructor * */
    public LongColumnSpec()
    {
        super();
    }

    /**
     * Constructs a <code>LongColumnSpec</code> with column options assuming
     ...
     */
    public LongColumnSpec(String columnName, ColumnOption columnOption, String getter, String setter,
        Object defaultValue)
    {
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with column options and a <code>GetterSetter</code> instance.
     *
     * @param columnName        column name.
     * @param columnOption      <code>ColumnOption</code> instance to use.
     * @param defaultValue      value to use for default if column value is null.
     ...
     */
    public LongColumnSpec(String columnName, ColumnOption columnOption, GetterSetter getterSetter, Object defaultValue)
    {
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with three option values.
     *
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with no option values supplied.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with one option value.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with two option values.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>LongColumnSpec</code> with three option values and a <code>GetterSetter</code> implementation.
     *
     * @param columnName        name of the column
     ...
     * <code>java.sql.Types.BIGINT</code> for the type.
     */
    protected void initColumnParameters()
    {
        this.i_precision = 11;
        this.i_scale = 0;
        this.i_sqlType = java.sql.Types.BIGINT;
    }
    ...
    {
        Long integer = (Long) obj;// force a runtime error if not a Long
        return (integer == null ? "null" : integer.toString());
    }// formatForSql(...)


    /**
     * Gets the columnClass attribute of the LongColumnSpec object
     *
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getLong(this.getColumnIdx());
    }
    ...
    public Object decode(String aString)
    {
        ...
        try
        {
            returnValue = Long.valueOf(aString);
        }
        catch (NumberFormatException e)
        {
            throw new DatabaseException(
                "Invalid parameter to LongColumnSpec.getValueFrom(aString))");
        }
        return returnValue;
    }
    ...
    {
        if (super.i_sequencedPrimaryKey)
        {
            return dbPolicy.getAutoIncrementNumericColumnType();
        }
        return "INTEGER";
    }
    ...
    {
        return new LongJoinColumn(this.getColumnName(),
            this.getSetter());
    }
