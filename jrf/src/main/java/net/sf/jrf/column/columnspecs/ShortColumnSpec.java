...
public class ShortColumnSpec
     extends NumericColumnSpec
{

    /* ===============  Static Variables  =============== */
    protected final static Class s_class = Short.class;


    /* ===============  Constructors  =============== */
    /** Default constructor * */
    public ShortColumnSpec()
    {
        super();
    }

    /**
     * Constructs a <code>ShortColumnSpec</code> with column options assuming
     ...
     */
    public ShortColumnSpec(String columnName, ColumnOption columnOption, String getter, String setter,
        Object defaultValue)
    {
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with column options and a <code>GetterSetter</code> instance.
     *
     * @param columnName        column name.
     * @param columnOption      <code>ColumnOption</code> instance to use.
     * @param defaultValue      value to use for default if column value is null.
     ...
     */
    public ShortColumnSpec(String columnName, ColumnOption columnOption, GetterSetter getterSetter, Object defaultValue)
    {
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with three option values.
     *
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with no option values supplied.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with one option value.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with two option values.
     *
     * @param columnName    name of the column
     * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
     * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
    ...
    /**
     * Constructs a <code>ShortColumnSpec</code> with three option values and a <code>GetterSetter</code> implementation.
     *
     * @param columnName        name of the column
     ...
     * of <code>5</code> for the precision, <code>0</code> for the scale and
     * <code>java.sql.Types.SMALLINT</code> for the type.
     */
    protected void initColumnParameters()
    {
        this.i_precision = 5;
        this.i_scale = 0;
        this.i_sqlType = java.sql.Types.SMALLINT;
    }
    ...
    {
        Short shortobj = (Short) obj;// force a runtime error if not an Short
        return (shortobj == null ? "null" : shortobj.toString());
    }// formatForSql(...)


    /**
     * Gets the columnClass attribute of the ShortColumnSpec object
     *
    ...
    /**
     * This ensures we get an Short (instead of a something
     * else) from the JDBC driver.
     *
     * @param jrfResultSet      a value of type 'JDBCHelper'
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getShort(this.getColumnIdx());
    }
    ...
    public Object decode(String aString)
    {
        ...
        try
        {
            returnValue = Short.valueOf(aString);
        }
        catch (NumberFormatException e)
        {
            throw new DatabaseException(
                "Invalid parameter to ShortColumnSpec.getValueFrom(aString))");
        }
        return returnValue;
    }
    ...
    {
        return new ShortJoinColumn(this.getColumnName(),
            this.getSetter());
    }
