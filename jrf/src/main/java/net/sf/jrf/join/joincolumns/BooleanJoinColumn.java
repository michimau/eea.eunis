...
/**
 *  This subclass of JoinColumn represents an Boolean column we want joined
 *  from another table.
 */
public class BooleanJoinColumn
     extends JoinColumn
{
     ...
     */
    public BooleanJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getBoolean(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the BooleanJoinColumn object
     *
