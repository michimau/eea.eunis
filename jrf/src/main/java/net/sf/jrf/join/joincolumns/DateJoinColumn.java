...
/**
 *  This subclass of JoinColumn represents a <code>java.util.Date</code> column (stored as a long)
 *  we want joined from another table.
 */
public class DateJoinColumn extends JoinColumn
{

    /* ===============  Static Variables  =============== */
    protected static Class s_class = Date.class;
     ...
     */
    public DateJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        Timestamp result = jrfResultSet.getTimestamp(i_columnIdx);
        return result == null ? null : new Date(result.getTime());
    }


    /**
     * Gets the columnClass attribute of the DateJoinColumn object
     *
