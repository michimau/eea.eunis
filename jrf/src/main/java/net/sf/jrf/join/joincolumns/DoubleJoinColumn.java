...
/**
 *  This subclass of JoinColumn represents an Double column we want joined
 *  from another table.
 */
public class DoubleJoinColumn
     extends JoinColumn
{

    /* ===============  Static Variables  =============== */
    protected static Class s_class = Double.class;
     ...
     */
    public DoubleJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getDouble(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the DoubleJoinColumn object
     *
