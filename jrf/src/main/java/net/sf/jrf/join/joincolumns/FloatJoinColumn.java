...
/**
 *  This subclass of JoinColumn represents an Float column we want joined
 *  from another table.
 */
public class FloatJoinColumn
     extends JoinColumn
{

    /* ===============  Static Variables  =============== */
    protected static Class s_class = Float.class;
     ...
     */
    public FloatJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getFloat(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the FloatJoinColumn object
     *
