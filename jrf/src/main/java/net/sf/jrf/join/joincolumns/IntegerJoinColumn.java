...
/**
 *  This subclass of JoinColumn represents an Integer column we want joined
 *  from another table.
 */
public class IntegerJoinColumn
     extends JoinColumn
{
     ...
     */
    public IntegerJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getInteger(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the IntegerJoinColumn object
     *
