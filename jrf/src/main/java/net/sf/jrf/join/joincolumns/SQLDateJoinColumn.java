...
/**
 *  This subclass of JoinColumn represents a java.sql.Date column that
 *  we want joined from another table.  Note that this is different from
 *  java.util.Date.
 */
public class SQLDateJoinColumn
     extends JoinColumn
{
     ...
     */
    public SQLDateJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getDate(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the SQLDateJoinColumn object
     *
