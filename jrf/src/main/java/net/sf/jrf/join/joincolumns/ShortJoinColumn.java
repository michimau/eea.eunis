...
/**
 *  This subclass of JoinColumn represents an Short column we want joined
 *  from another table.
 */
public class ShortJoinColumn
     extends JoinColumn
{

    /* ===============  Static Variables  =============== */
    protected static Class s_class = Short.class;
     ...
     */
    public ShortJoinColumn(String columnName, GetterSetter getterSetterImpl)
    {
    ...
    public Object getColumnValueFrom(JRFResultSet jrfResultSet)
        throws SQLException
    {
        return jrfResultSet.getShort(i_columnIdx);
    }


    /**
     * Gets the columnClass attribute of the ShortJoinColumn object
     *
