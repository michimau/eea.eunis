 ...
 * retrieves returns a <code>java.util.List</code>.
 */
public class ApplicationRowHandlerList implements ApplicationRowHandler
{

    protected ArrayList list = new ArrayList();
    private static Category LOG = Category.getInstance(ApplicationRowHandlerList.class.getName());

    /**Constructor for the ApplicationRowHandlerList object */
    public ApplicationRowHandlerList() { }
    ...
    /** Trims list down to current size to save resources. */
    public void trim()
    {
        list.trimToSize();
    }
     ...
     *
     * @return   result <code>java.util.List</code> from a database query.
     */
