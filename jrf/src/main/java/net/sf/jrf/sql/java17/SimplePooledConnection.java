...
public class SimplePooledConnection implements javax.sql.PooledConnection, java.sql.Connection
{
    ...
    private Vector statListeners; // Registered StatementEventListeners .. New Since 1.7
    ...
    SimplePooledConnection(Connection connection)
    {
        ...
        statListeners = new Vector(); //New Since 1.7
    ...
    /*
     * New methods since Java 1.7
     */

    // FIXME: Untested
    @Override
    public void addStatementEventListener(StatementEventListener listener) {
        if (statListeners.contains(listener) == false) {
            statListeners.addElement(listener);
        }
    }

    @Override
    public void removeStatementEventListener(StatementEventListener listener) {
        statListeners.removeElement(listener);
    }
