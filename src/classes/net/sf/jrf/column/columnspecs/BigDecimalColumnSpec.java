 ...
 * All Rights Reserved.
 *
 * Contributor: Alix Jermyn (IconMediaLab Belgium -
...
public class BigDecimalColumnSpec
        extends NumericColumnSpec {

  /* ===============  Static Variables  =============== */
  protected final static Class s_class = java.math.BigDecimal.class;

  /** Default Constructor * */
  public BigDecimalColumnSpec() {
    super();
  }

  /* ===============  Constructors  =============== */
  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with column options assuming
   ...
   */
  public BigDecimalColumnSpec(String columnName, ColumnOption columnOption, String getter, String setter,
                              Object defaultValue) {
    super(columnName, columnOption, getter, setter, defaultValue);
  }

  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with column options and a <code>GetterSetter</code> instance.
   *
   * @param columnName        column name.
   * @param columnOption      <code>ColumnOption</code> instance to use.
   * @param defaultValue      value to use for default if column value is null.
   ...
   */
  public BigDecimalColumnSpec(String columnName, ColumnOption columnOption, GetterSetter getterSetter, Object defaultValue) {
    super(columnName, columnOption, getterSetter, defaultValue);
  }


  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with three option values.
   *
  ...
  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with no option values supplied.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with one option value.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with two option values.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>BigDecimalColumnSpec</code> with three option values and a <code>GetterSetter</code> implementation.
   *
   * @param columnName        name of the column
   ...
   * <code>java.sql.Types.DECIMAL</code> for the type.
   */
  ...
  public String formatForSql(Object obj, DatabasePolicy dbPolicy) {
    // force a runtime error if not a BigDecimal
  ...
  /**
   * Gets the columnClass attribute of the BigDecimalColumnSpec object
   *
  ...
  /**
   * This ensures we get a Big Decimal (instead of an Integer or something
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return jrfResultSet.getBigDecimal(this.getColumnIdx());
  }
  ...
  public Object decode(String aString) {
    ...
    try {
      returnValue = new BigDecimal(aString);
    } catch (NumberFormatException e) {
      throw new DatabaseException(
              "Invalid parameter sent to BigDecimalColumnSpec.getValueFrom('"
              + aString + "') ");
    }
    return returnValue;
  }
  ...
  public JoinColumn buildJoinColumn() {
    return new BigDecimalJoinColumn(this.getColumnName(),
            this.getSetter());
  }
  ...
  public void setPreparedColumnValueTo(JRFPreparedStatement stmt, Object value, int position)
          throws SQLException {
    stmt.setBigDecimal(value, position);
  }

}// BigDecimalColumnSpec
