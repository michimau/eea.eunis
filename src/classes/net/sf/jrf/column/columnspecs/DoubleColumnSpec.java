...
public class DoubleColumnSpec
  ...
  /* ===============  Static Variables  =============== */
  protected final static Class s_class = Double.class;
  ...
  /**
   * Constructs a <code>DoubleColumnSpec</code> with column options assuming
   ...
   */
  public DoubleColumnSpec(String columnName, ColumnOption columnOption, String getter, String setter,
                          Object defaultValue) {
    super(columnName, columnOption, getter, setter, defaultValue);
  }

  /**
   * Constructs a <code>DoubleColumnSpec</code> with column options and a <code>GetterSetter</code> instance.
   *
   * @param columnName        column name.
   * @param columnOption      <code>ColumnOption</code> instance to use.
   * @param defaultValue      value to use for default if column value is null.
   ...
   */
  public DoubleColumnSpec(String columnName, ColumnOption columnOption, GetterSetter getterSetter, Object defaultValue) {
    super(columnName, columnOption, getterSetter, defaultValue);
  }


  /**
   * Constructs a <code>DoubleColumnSpec</code> with three option values.
   *
  ...
  /**
   * Constructs a <code>DoubleColumnSpec</code> with no option values supplied.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>DoubleColumnSpec</code> with one option value.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>DoubleColumnSpec</code> with two option values.
   *
   * @param columnName    name of the column
   * @param getter        name of the method to get the column data from the <code>PersistentObject</code>
   * @param setter        name of the method to set column data in the <code>PersistentObject</code>.
  ...
  /**
   * Constructs a <code>DoubleColumnSpec</code> with three option values and a <code>GetterSetter</code> implementation.
   *
   * @param columnName        name of the column
   ...
   * of <code>11</code> for the precision, <code>5</code> for the scale and
   * <code>java.sql.Types.DOUBLE</code> for the type.
   */
  protected void initColumnParameters() {
    this.i_precision = 11;
    this.i_scale = 5;
    this.i_sqlType = java.sql.Types.DOUBLE;
  }
  ...
  /**
   * Gets the columnClass attribute of the DoubleColumnSpec object
   *
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return jrfResultSet.getDouble(this.getColumnIdx());
  }
