 ...
 */
public class CurrentPersistentState
  ...
  public void markCurrentPersistentState(PersistentObject aPO) {
    // Do nothing since we're already current.
  }
  ...
  /**
   * Gets the modifiedPersistentState attribute of the CurrentPersistentState object
   *
  ...
  /**
   * Gets the newPersistentState attribute of the CurrentPersistentState object
   *
  ...
  /**
   * Gets the currentPersistentState attribute of the CurrentPersistentState object
   *
  ...
  /**
   * Gets the deadPersistentState attribute of the CurrentPersistentState object
   *
  ...
  /**
   * Gets the deletedPersistentState attribute of the CurrentPersistentState object
   *
  ...
  public boolean equals(Object anObject) {
    return (anObject instanceof CurrentPersistentState);
  }
