...
import net.sf.jrf.column.columnspecs.DayOfWeekColumnSpec;
import net.sf.jrf.join.*;

import net.sf.jrf.sql.JRFResultSet;

/** */
public class DayOfWeekJoinColumn
        extends JoinColumn {

  /* ===============  Static Variables  =============== */
  protected static Class s_class = Integer.class;

  /** Simple data formatter using 'EEE' * */
  protected SimpleDateFormat formatter = DayOfWeekColumnSpec.createFormatter();
   ...
   */
  public DayOfWeekJoinColumn(String columnName, GetterSetter getterSetterImpl) {
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return DayOfWeekColumnSpec.getColumnValueFrom(formatter, jrfResultSet, i_columnIdx);
  }


  /**
   * Gets the columnClass attribute of the DayOfWeekJoinColumn object
   *
