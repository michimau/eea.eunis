...
public class LongJoinColumn
  ...
  /* ===============  Static Variables  =============== */
  protected static Class s_class = Long.class;
   ...
   */
  public LongJoinColumn(String columnName, GetterSetter getterSetterImpl) {
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return jrfResultSet.getLong(i_columnIdx);
  }


  /**
   * Gets the columnClass attribute of the LongJoinColumn object
   *
