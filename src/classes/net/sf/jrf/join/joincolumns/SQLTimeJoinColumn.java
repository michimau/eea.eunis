...
/**
 *  This subclass of JoinColumn represents a java.sql.Time column that
 *  we want joined from another table.
 */
public class SQLTimeJoinColumn
        extends JoinColumn {

  /* ===============  Static Variables  =============== */
  protected static Class s_class = Time.class;
   ...
   */
  public SQLTimeJoinColumn(String columnName, GetterSetter getterSetterImpl) {
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return jrfResultSet.getTime(i_columnIdx);
  }


  /**
   * Gets the columnClass attribute of the SQLTimeJoinColumn object
   *
