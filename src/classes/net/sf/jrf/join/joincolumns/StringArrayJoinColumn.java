...
import net.sf.jrf.column.columnspecs.StringArrayColumnSpec;
...
public class StringArrayJoinColumn
  ...
  /* ===============  Static Variables  =============== */
  protected final static Class s_class = String[].class;

  /* ===============  Instance Variables  =============== */
  protected String i_delimiter = StringArrayColumnSpec.COMMA;
   ...
   */
  public StringArrayJoinColumn(String columnName, GetterSetter getterSetterImpl) {
  ...
  /**
   * Gets the columnValueFrom attribute of the StringArrayJoinColumn object
   *
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    String string = jrfResultSet.getString(i_columnIdx);
    return StringArrayColumnSpec.arrayFromDelimitedString(string, i_delimiter);
  }


  /**
   * Gets the columnClass attribute of the StringArrayJoinColumn object
   *
