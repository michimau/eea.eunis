...
/**
 *  This subclass of JoinColumn represents a String column we want joined
 *  from another table.
 */
public class StringJoinColumn
   ...
   */
  public StringJoinColumn(String columnName, GetterSetter getterSetterImpl) {
    super(columnName, getterSetterImpl);
  }

  /**
   * Gets the columnValueFrom attribute of the StringJoinColumn object
   *
  ...
  public Object getColumnValueFrom(JRFResultSet jrfResultSet)
          throws SQLException {
    return jrfResultSet.getString(i_columnIdx);
  }


  /**
   * Gets the columnClass attribute of the StringJoinColumn object
   *
