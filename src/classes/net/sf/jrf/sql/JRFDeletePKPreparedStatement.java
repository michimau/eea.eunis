 ...
 * SQL delete by primary key using column specifications.
 *
 * @see   net.sf.jrf.column.ColumnSpec
 */
public class JRFDeletePKPreparedStatement extends JRFPrimaryKeyPreparedStatement {
  /** log4j category for debugging and errors */
  private final static Category LOG = Category.getInstance(JRFDeletePKPreparedStatement.class.getName());
   ...
   */
  JRFDeletePKPreparedStatement(ColumnSpec primaryKeyColSpec, String tableName,
    ...
    // Build the SQL
    super.sql = "DELETE FROM " + tableName + " WHERE " +
            primaryKeyColSpec.buildPreparedWhereClause(tableName);
  }
