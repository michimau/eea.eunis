...
{
  private static byte[] key ={ (byte)0x03,(byte)0xE2,(byte)0xA2,(byte)0x15,(byte)0x29,(byte)0xCD,(byte)0xEF,(byte)0xDB };
...
class Crypt
{
  ...
  public byte[] encryptString( final String text )
  {
    try
    {
      final javax.crypto.Cipher cipher = javax.crypto.Cipher.getInstance(this.algorithm);
