...
public class HabitatsFactsheet {
  ...
  public Chm62edtHabitatInternationalNamePersist getHabitatInternational(String englishName) throws InitializationException {
    if (null == englishName) throw new InitializationException("idHabitat was null. This is unacceptable.");
    ...
    try {
      ...
      if (list.size() > 0) ret = (Chm62edtHabitatInternationalNamePersist) list.get(0);
    } catch (Exception ex) {
      ex.printStackTrace(System.err);
      ret = null;
    }
  ...
  public Vector getHabitatSintaxa() throws InitializationException {
    if (null == idHabitat) throw new InitializationException("idHabitat was null. This is unacceptable.");
  ...
  public Vector getHabitatClimate() throws InitializationException {
    if (null == idHabitat) throw new InitializationException("idHabitat was null. Cannot retrieve information.");
    Vector res = new Vector();
    try
    {
  ...
  private CodeLevelWrapper findHabitatEunisCodeLevel(final Integer idHabitat) throws InitializationException {
    ...
    try
    {
      ...
      if (null == ret) ret = new CodeLevelWrapper();
    } catch (Exception ex) {
      ex.printStackTrace(System.err);
      ret = new CodeLevelWrapper();
    } finally {
  ...
  private String findScientificName(Integer idHabitat) throws InitializationException {
    ...
    try
    {
      ...
      {
        Chm62edtHabitatPersist habitat = (Chm62edtHabitatPersist) list.get(0);
        if (null != habitat) ret = habitat.getScientificName();
      }
      if (null == ret) ret = "na";
    } catch (Exception ex) {
      ex.printStackTrace(System.err);
...
//  }
  ...
  public static String mapHabitatsRelations(String relation) {
    if (null == relation) return "n/a";
    if (relation.equalsIgnoreCase("<")) return "narrower";
    if (relation.equalsIgnoreCase(">")) return "wider";
    if (relation.equalsIgnoreCase("=")) return "same";
    if (relation.equalsIgnoreCase("#")) return "overlap";
    if (relation.equalsIgnoreCase("?")) return "not defined";
    if (relation.equalsIgnoreCase("s")) return "source";
    if (relation.equalsIgnoreCase("")) return "n/a";
    return relation;
  }
  ...
  public boolean isAnnexI() {
    if (0 == ANNEX_I_HABITAT.compareTo(getHabitatType())) return true;
    return false;
  }
  ...
  public Integer getHabitatLevel() {
    ...
    if (null == level) level = new Integer(0);
    return level;
  }
  ...
  public String getEunisHabitatCode() {
    ...
    if (null == eunisCode) eunisCode = "na";
    return eunisCode;
  }
  ...
  public Short getPriority() {
    ...
    if (null == priority) priority = new Short("0");
    return priority;
  }
  ...
  public String getCodeAnnex1() {
    ...
    if (null == codeannex1) codeannex1 = "na";
    return codeannex1;
  }
