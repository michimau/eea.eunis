...
public class SiteFactsheet {
  ...
  public Chm62edtReportAttributesPersist findSiteAttributes(String attributeName, Integer idReportAttribute) {
    ...
    try {
      List results = new Chm62edtReportAttributesDomain().findWhere("NAME LIKE '%" + attributeName + "%' AND ID_REPORT_ATTRIBUTES='" + idReportAttribute + "'");
...
//
   ...
   public List findEunisSpeciesListedAnnexesDirectivesForSitesNatura2000() {
    List results = new Vector();
    try {
      results = new SitesSpeciesReportAttributesDomain().findWhere("A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' AND E.NAME='SOURCE_TABLE' AND E.VALUE IN ('AMPREP','BIRD','FISHES','INVERT','MAMMAL','PLANT')");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findNotEunisSpeciesListedAnnexesDirectives() {
    List results = new Vector();
    try {
      results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE IN ('AMPREP','BIRD','FISHES','INVERT','MAMMAL','PLANT') AND NAME LIKE 'OTHER_SPECIES_%' GROUP BY SUBSTRING(name,length(name) - instr(reverse(name),'_') + 2)");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findNotEunisSpeciesOtherMentioned() {
     List results = new Vector();
     try {
       results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'SPEC' AND NAME LIKE 'OTHER_SPECIES_%' GROUP BY SUBSTRING(name,length(name) - instr(reverse(name),'_') + 2)");
     } catch (Exception _ex) {
       _ex.printStackTrace(System.err);
       results = new Vector();
     }
  ...
  public Chm62edtSitesAttributesPersist findNotEunisSpeciesListedAnnexesDirectivesAttributes(String attrName) {
    ...
    try
    {
      List attrList = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE IN ('AMPREP','BIRD','FISHES','INVERT','MAMMAL','PLANT') AND NAME = 'OTHER_SPECIES_" + attrName + "'");
   ...
   public Chm62edtSitesAttributesPersist findNotEunisSpeciesOtherMentionedAttributes(String attrName) {
    ...
    try
    {
      List attrList = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'SPEC' AND NAME = 'OTHER_SPECIES_" + attrName + "'");
      if(attrList != null && attrList.size()>0)
      {
         result = (Chm62edtSitesAttributesPersist)attrList.get(0);
      }
  ...
  public List findEunisSpeciesOtherMentionedForSitesNatura2000() {
    List results = new Vector();
    try {
      results = new SitesSpeciesReportAttributesDomain().findWhere("A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' AND E.NAME='SOURCE_TABLE' AND E.VALUE ='spec'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findSitesSpeciesByIDNatureObjectNatura2000Other() {
    List results = new Vector();
    try {
      results = new SiteSpeciesDomain().findWhere("A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' AND A.ID_REPORT_TYPE='-999'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findSitesSpecificSpecies() {
    ...
    try
    {
      results = new Chm62edtSitesAttributesDomain().findWhere("NAME LIKE 'SPECIES%' AND ID_SITE='" + getSiteObject().getIdSite() + "'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findSitesSpecificSpeciesNatura2000Other() {
    ...
    try
    {
      results = new Chm62edtSitesAttributesDomain().findWhere("NAME LIKE 'OTHER_SPECIES%' AND ID_SITE='" + getSiteObject().getIdSite() + "'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findHumanActivity() {
    List results;
    try {
      results = new HumanActivityDomain().findWhere("LOOKUP_TYPE = 'HUMAN_ACTIVITY' AND ID_SITE='" + getSiteObject().getIdSite() + "'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public HumanActivityAttributesPersist findHumanActivityAttribute(String attribute) {
    ...
    try {
      List results = new HumanActivityAttributesDomain().findWhere("LOOKUP_TYPE = 'HUMAN_ACTIVITY' AND ID_SITE='" + getSiteObject().getIdSite() + "' AND C.NAME='" + attribute + "'");
      if (null != results && results.size() > 0) {
  ...
  public List findHabit1Eunis() {
    List results = new Vector();
    try {
      results = new SiteHabitatsDomain().findWhere("A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' and CHM62EDT_REPORT_ATTRIBUTES.NAME='SOURCE_TABLE' and CHM62EDT_REPORT_ATTRIBUTES.VALUE='habit1'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findHabit1NotEunis() {
       List results = new Vector();
       try {
         results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'HABIT1' AND NAME LIKE 'HABITAT_CODE_%' GROUP BY SUBSTRING(name,length(name) - instr(reverse(name),'_') + 2)");
       } catch (Exception _ex) {
         _ex.printStackTrace(System.err);
         results = new Vector();
       }
  ...
  public Chm62edtSitesAttributesPersist findHabit1NotEunisAttributes(String attrName) {
    ...
    try
    {
      List attrList = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'HABIT1' AND NAME = 'HABITAT_" + attrName + "'");
      if(attrList != null && attrList.size()>0)
      {
         result = (Chm62edtSitesAttributesPersist)attrList.get(0);
      }
   ...
   public Chm62edtSitesAttributesPersist findHabit2NotEunisAttributes(String attrName) {
    ...
    try
    {
      List attrList = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'HABIT2' AND NAME = 'HABITAT_" + attrName + "'");
      if(attrList != null && attrList.size()>0)
      {
         result = (Chm62edtSitesAttributesPersist)attrList.get(0);
      }
   ...
   public List findHabit2NotEunis() {
       List results = new Vector();
       try {
         results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'HABIT2' AND NAME LIKE 'HABITAT_CODE_%' GROUP BY SUBSTRING(name,length(name) - instr(reverse(name),'_') + 2)");
       } catch (Exception _ex) {
         _ex.printStackTrace(System.err);
         results = new Vector();
       }
  ...
  public List findHabit2Eunis() {
    List results = new Vector();
    try {
      results = new SiteHabitatsDomain().findWhere("A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' and CHM62EDT_REPORT_ATTRIBUTES.NAME='SOURCE_TABLE' and CHM62EDT_REPORT_ATTRIBUTES.VALUE='habit2'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
...
//  }
  ...
  public List findSitesSpecificHabitats() {
    List results = new Vector();
    try {
      results = new Chm62edtSitesAttributesDomain().findWhere(" NAME LIKE 'HABITAT_CODE_%' AND ID_SITE='" + getSiteObject().getIdSite() + "' group by name");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findSiteRelationsNatura2000Natura2000() {
    List results = new Vector();
    try {
      results = new SiteRelationsDomain().findWhere("A.ID_SITE='" + getSiteObject().getIdSite() + "' AND B.SOURCE_DB = 'NATURA2000' AND A.SOURCE_TABLE = 'sitrel'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public List findSiteRelationsNatura2000Corine() {
    List results = new Vector();
    try {
      results = new SiteRelationsDomain().findWhere("A.ID_SITE='" + getSiteObject().getIdSite() + "' AND B.SOURCE_DB = 'NATURA2000' AND A.SOURCE_TABLE = 'corine'");
    } catch (Exception _ex) {
      _ex.printStackTrace(System.err);
      results = new Vector();
    }
  ...
  public int getType() {
    ...
    if (typeStr.equalsIgnoreCase("NATURA2000")) return SiteFactsheet.TYPE_NATURA2000;
    if (typeStr.equalsIgnoreCase("CORINE")) return SiteFactsheet.TYPE_CORINE;
    if (typeStr.equalsIgnoreCase("DIPLOMA")) return SiteFactsheet.TYPE_DIPLOMA;
    if (typeStr.equalsIgnoreCase("CDDA_NATIONAL")) return SiteFactsheet.TYPE_CDDA_NATIONAL;
    if (typeStr.equalsIgnoreCase("CDDA_INTERNATIONAL")) return SiteFactsheet.TYPE_CDDA_INTERNATIONAL;
    if (typeStr.equalsIgnoreCase("BIOGENETIC")) return SiteFactsheet.TYPE_BIOGENETIC;
    if (typeStr.equalsIgnoreCase("NATURENET")) return SiteFactsheet.TYPE_NATURENET;
    if (typeStr.equalsIgnoreCase("EMERALD")) return SiteFactsheet.TYPE_EMERALD;
    return -1;
  }
  ...
  private Chm62edtSitesPersist getSiteinformation() throws InitializationException {
    if (null == idSite) throw new InitializationException("idSite was null, aborting.");
    Chm62edtSitesPersist retObject = null;
    // Get the cached information
    if (null != siteTableObject) return siteTableObject;
  ...
  public String getDesignation() throws InitializationException
  {
    ...
    // Get the cached information
    if (null != siteTableDesignations) return siteTableDesignations;
    // If not initialized - get the data from DB into cache
    try
    {
      List results = new Chm62edtDesignationsDomain().findCustom(" SELECT A.* FROM CHM62EDT_DESIGNATIONS AS A " +
      ...
      if (null != results && results.size() > 0)
      {
        ...
        siteTableDesignations = (descr == null || descr.trim().length() <= 0 ?(descrEn == null || descrEn.trim().length() <= 0 ? (descrFr == null || descrFr.trim().length() <= 0 ? "" : descrFr) : descrEn) : descr ); // Save information in cache
  ...
  private Chm62edtSitesAttributesPersist getSiteAttributes() throws InitializationException {
    ...
    // Get the cached information
    if (null != siteTableAttributes) return siteTableAttributes;
    // If not initialized - get the data from DB into cache
    try {
  ...
  public List findAdministrativeRegionCodes() {
    ...
    try 
    {
      res = new RegionsCodesDomain().findWhere("ID_SITE='" + idSite + "' AND C.LOOKUP_TYPE='REGION_CODE' GROUP BY D.ID_REGION_CODE, D.NAME, E.VALUE");
  ...
  public String getHabitatCharacterization() {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME='HABITAT_CHARACTERIZATION'");
      if (null != results && results.size() > 0) {
  ...
  public String getFloraCharacterization() {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME='FLORA_CHARACTERIZATION'");
      if (null != results && results.size() > 0) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
  ...
  public String getFaunaCharacterization() {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME='FAUNA_CHARACTERIZATION'");
      if (null != results && results.size() > 0) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
  ...
  public String getReferenceDocumentNumber() {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME='REFERENCE_DOCUMENT_NUMBER'");
      if (null != results && !results.isEmpty()) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
  ...
  public String getReferenceDocumentSource() {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME='REFERENCE_DOCUMENT_SOURCE'");
      if (null != results && !results.isEmpty()) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
  ...
  public String findSiteAttribute(String attrName) {
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME LIKE '" + attrName + "%' AND SOURCE_DB='" + getSiteObject().getSourceDB() + "'");
      if (null != results && !results.isEmpty()) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
   ...
   */
    ...
    String res = "";
    try {
      List results = new Chm62edtSitesAttributesDomain().findWhere("ID_SITE='" + idSite + "' AND NAME = '" + attrName + "' AND SOURCE_DB='" + getSiteObject().getSourceDB() + "'");
      if (null != results && !results.isEmpty()) {
        Chm62edtSitesAttributesPersist persist = (Chm62edtSitesAttributesPersist) results.get(0);
        res = persist.getValue();
      }
  ...
  public Integer getIDNatureObject() {
   ...
   public List findSiteRelationsNatura2000Desigc() {
       List results = new Vector();
       try {
         results = new DesignationsSitesRelatedDesignationsDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'DESIGC' group by id_designation, description_en,NATIONAL_CATEGORY,overlap");
       } catch (Exception _ex) {
         _ex.printStackTrace(System.err);
         results = new Vector();
       }
   ...
   public List findSiteRelationsNatura2000Desigr() {
       List results = new Vector();
       try {
         results = new DesignationsSitesRelatedDesignationsDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' AND SOURCE_TABLE = 'DESIGR' group by designated_site,description_en,NATIONAL_CATEGORY,overlap,overlap_type");
       } catch (Exception _ex) {
         _ex.printStackTrace(System.err);
         results = new Vector();
       }
  ...
  public List findSiteRelationsCorine() {
      List results = new Vector();
      try {
        results = new DesignationsSitesRelatedDesignationsDomain().findWhere("ID_SITE='" + getSiteObject().getIdSite() + "' group by designated_site,description_en,NATIONAL_CATEGORY,overlap,overlap_type");
      } catch (Exception _ex) {
        _ex.printStackTrace(System.err);
        results = new Vector();
      }
  ...
  /**
   ...
   public List findSitesHabitatsByIDNatureObject() {
     ...
     try {
       ...
       results = new SiteHabitatsDomain().findWhere(isGoodHabitat + " AND A.ID_NATURE_OBJECT='" + getSiteObject().getIdNatureObject() + "' GROUP BY CHM62EDT_HABITAT.ID_NATURE_OBJECT, CHM62EDT_SITES.ID_NATURE_OBJECT");
     } catch (Exception _ex) {
       _ex.printStackTrace(System.err);
       results = new Vector();
     }
