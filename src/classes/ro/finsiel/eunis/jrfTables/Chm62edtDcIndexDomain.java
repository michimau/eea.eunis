...
public class Chm62edtDcIndexDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("REFCD", "getRefcd", "setRefcd", DEFAULT_TO_NULL));
    this.addColumnSpec(new IntegerColumnSpec("REFERENCE", "getReference", "setReference", DEFAULT_TO_NULL));
    this.addColumnSpec(new StringColumnSpec("COMMENT", "getComment", "setComment", DEFAULT_TO_EMPTY_STRING));
  }
}