...
public class Chm62edtHabitatDescriptionDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("OWNER_TEXT", "getOwnerText", "setOwnerText", null));
    this.addColumnSpec(new IntegerColumnSpec("ID_DC", "getIdDc", "setIdDc", DEFAULT_TO_ZERO));

    JoinTable langTable = new JoinTable("CHM62EDT_LANGUAGE", "ID_LANGUAGE", "ID_LANGUAGE");
    langTable.addJoinColumn(new StringJoinColumn("NAME_EN", "setLanguageName"));
