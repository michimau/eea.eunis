  ...
  public void setup() {
    ...
    this.addColumnSpec(
            new CompoundPrimaryKeyColumnSpec(
                    ...
                    new IntegerColumnSpec("ID_HABITAT_LINK", "getIdHabitatLink", "setIdHabitatLink", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY),
                    new StringColumnSpec("RELATION_TYPE", "getRelationType", "setRelationType", DEFAULT_TO_EMPTY_STRING, NATURAL_PRIMARY_KEY)
            )
    );
  }
}
