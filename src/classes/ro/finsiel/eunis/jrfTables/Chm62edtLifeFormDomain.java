...
public class Chm62edtLifeFormDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_LIFE_FORM", "getIdLifeForm", "setIdLifeForm", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
    ...
    this.addColumnSpec(new TimestampColumnSpec("DATE_ADDED", "getDateAdded", "setDateAdded", null));
  }
}