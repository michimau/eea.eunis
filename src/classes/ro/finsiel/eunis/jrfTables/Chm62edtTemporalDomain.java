...
public class Chm62edtTemporalDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_TEMPORAL", "getIdTemporal", "setIdTemporal", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
    ...
    this.addColumnSpec(new IntegerColumnSpec("USED", "getUsed", "setUsed", DEFAULT_TO_NULL));
  }
}