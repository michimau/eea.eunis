...
public class WebContentDomain extends AbstractDomain
{
  ...
  public void setup()
  {
    ...
    this.addColumnSpec( new StringColumnSpec("ID_PAGE", "getIDPage", "setIDPage", DEFAULT_TO_EMPTY_STRING, NATURAL_PRIMARY_KEY ) );
    this.addColumnSpec( new StringColumnSpec( "CONTENT", new NullableColumnOption(), "getContent", "setContent", null) );
    this.addColumnSpec( new StringColumnSpec( "DESCRIPTION", new NullableColumnOption(), "getDescription", "setDescription", null ) );
    this.addColumnSpec( new StringColumnSpec("LANG", "getLang", "setLang", "en" ) );
    this.addColumnSpec( new ShortColumnSpec( "LANG_STATUS", new NullableColumnOption(), "getLangStatus", "setLangStatus", DEFAULT_TO_ONE ) );
    this.addColumnSpec( new ShortColumnSpec( "CONTENT_LENGTH", new NullableColumnOption(), "getContentLength", "setContentLength", DEFAULT_TO_ZERO ) );
