...
public class NamesDomain extends AbstractDomain implements Paginable {
  ...
  /** Extra criteria applied to search (from first page). These criterias differs from that are computer as SQL **OR**
   * NOT **AND** as are searchCriteria */
   ...
   * @param searchPlace Where to search. This can be: this.SEARCH_EUNIS or this.SEARCH_ANNEX_I. Default to SEARCH_EUNIS
   */
...
//    System.out.println("sql is: " + filterSQL);
