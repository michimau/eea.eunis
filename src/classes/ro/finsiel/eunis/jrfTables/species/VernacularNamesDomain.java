...
public class VernacularNamesDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    reportTypeAttributes = new JoinTable("CHM62EDT_REPORT_ATTRIBUTES F", "ID_REPORT_ATTRIBUTES", "ID_REPORT_ATTRIBUTES");
    reportTypeAttributes.addJoinColumn(new StringJoinColumn("VALUE", "setValue"));
