...
public class InfoQualityReportTypeDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_INFO_QUALITY", "getIdInfoQuality", "setIdInfoQuality", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
    this.addColumnSpec(new StringColumnSpec("STATUS", "getStatus", "setStatus", DEFAULT_TO_EMPTY_STRING, REQUIRED));
    this.addColumnSpec(new StringColumnSpec("DESCRIPTION", "getDescription", "setDescription", DEFAULT_TO_EMPTY_STRING, REQUIRED));

    JoinTable reportType = new JoinTable("CHM62EDT_REPORT_TYPE", "ID_INFO_QUALITY", "ID_LOOKUP");
