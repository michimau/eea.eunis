...
public class SitesByNatureObjectDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("ID_SITE", "getIDSite", "setIDSite", DEFAULT_TO_NULL, NATURAL_PRIMARY_KEY));
    ...
    this.addColumnSpec(new StringColumnSpec("AREA_NAME_EN", "getAreaNameEn", "setAreaNameEn", DEFAULT_TO_NULL));
  }
}
