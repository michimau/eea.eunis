...
public class CommonRecordsDomain extends AbstractDomain {


  /**
   **/
  public PersistentObject newPersistentObject() {
    return new CommonRecordsPersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_HABITAT", "getIdHabitat", "setIdHabitat", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
    ...
    JoinTable joinTable = new JoinTable("CHM62EDT_NATURE_OBJECT_GEOSCOPE A", "ID_NATURE_OBJECT", "ID_NATURE_OBJECT_LINK");
    joinTable.addJoinColumn(new IntegerJoinColumn("ID_NATURE_OBJECT", "idNO", "setidNO"));
    joinTable.addJoinColumn(new IntegerJoinColumn("ID_DC", "idDC", "setidDC"));
    this.addJoinTable(joinTable);

    JoinTable Rep = new JoinTable("CHM62EDT_NATURE_OBJECT_REPORT_TYPE B", "ID_NATURE_OBJECT_LINK", "ID_NATURE_OBJECT_LINK");
    Rep.addJoinColumn(new IntegerJoinColumn("ID_NATURE_OBJECT_LINK", "idNOLink", "setidNOLink"));
    joinTable.addJoinTable(Rep);

    JoinTable joinSpecies = new JoinTable("CHM62EDT_SPECIES AAA", "ID_NATURE_OBJECT", "ID_NATURE_OBJECT");
