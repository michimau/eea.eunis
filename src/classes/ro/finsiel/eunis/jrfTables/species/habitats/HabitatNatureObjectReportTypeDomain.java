...
public class HabitatNatureObjectReportTypeDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    JoinTable joinTable = new JoinTable("CHM62EDT_NATURE_OBJECT_REPORT_TYPE A", "ID_NATURE_OBJECT", "ID_NATURE_OBJECT_LINK");
    joinTable.addJoinColumn(new IntegerJoinColumn("ID_NATURE_OBJECT", "idNatObj", "setidNatObj"));
    this.addJoinTable(joinTable);

    OuterJoinTable Geo = new OuterJoinTable("CHM62EDT_NATURE_OBJECT_GEOSCOPE B", "ID_NATURE_OBJECT_LINK", "ID_NATURE_OBJECT_LINK");
    joinTable.addJoinColumn(new IntegerJoinColumn("ID_NATURE_OBJECT_LINK", "idNatObjLink", "setidNatObjLink"));
