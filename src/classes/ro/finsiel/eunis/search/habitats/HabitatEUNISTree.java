...
public class HabitatEUNISTree {
  ...
  public HabitatEUNISTree() {
    coduriL1 = new Chm62edtHabitatDomain().findWhereOrderBy("LEVEL = 1 AND ID_HABITAT>=1 and ID_HABITAT<10000", "EUNIS_HABITAT_CODE");
  }
  ...
  public String getTree(String arrayName, int level, int parentNodID, String parentCode) {
    ...
    if (level < maxlevel) {
      List lHabitats = null;
      String wildcard = "_";
      if (level == 3) wildcard = "._";
      if (level == 1)
        lHabitats = new Chm62edtHabitatDomain().findWhereOrderBy("LEVEL = " + level + " AND ID_HABITAT>=1 and ID_HABITAT<10000", "EUNIS_HABITAT_CODE");
      else
        lHabitats = new Chm62edtHabitatDomain().findWhereOrderBy("LEVEL = " + level + " AND ID_HABITAT>=1 and ID_HABITAT<10000 AND EUNIS_HABITAT_CODE LIKE '" + parentCode + wildcard + "'", "EUNIS_HABITAT_CODE");
