...
public class DictionaryBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    if (null != criteriaSearch && null != oper && null != criteriaType) {
      for (int i = 0; i < criteriaSearch.length; i++) {
        Integer _criteriaType = Utilities.checkedStringToInt(criteriaType[i], DictionarySearchCriteria.CRITERIA_SCIENTIFIC_NAME);
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showLevel", DictionaryBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showCode", DictionaryBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showScientificName", DictionaryBean.SHOW.toString()));
    if (null != showEnglishName && showEnglishName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showEnglishName", DictionaryBean.SHOW.toString()));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLevel", DictionaryBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showCode", DictionaryBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", DictionaryBean.SHOW.toString()));
    if (null != showEnglishName && showEnglishName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showEnglishName", DictionaryBean.SHOW.toString()));
