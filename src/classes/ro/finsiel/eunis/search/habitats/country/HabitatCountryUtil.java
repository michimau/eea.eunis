...
public class HabitatCountryUtil {
  ...
  public String getCountry(int index) {
    if (index < _countries.size()) {
      ...
      System.out.println(HabitatCountryUtil.class.getName() + "::getCountry(" + index + ") - Warning: element not removed. Array out of bounds.");
    }
    return null;
  }
  ...
  public String getRegion(int index) {
    if (index < _regions.size()) {
      ...
      System.out.println(HabitatCountryUtil.class.getName() + "::getRegionIDGeoscope(" + index + ") - Warning: element not removed. Array out of bounds");
    }
    return null;
  }
...
//       System.out.println("i="+i);
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < testV.size(); i++) {
      //System.out.println(testV.get(i));
    }
  }
}