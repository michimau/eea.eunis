...
public class NameBean extends AbstractFormBean {
  ...
  public void removeCriteriaExtra(int index) {
    if (index < 0 && index >= relationOpExtra.length) return;
  ...
  public AbstractSearchCriteria getMainSearchCriteria() {
    ...
    if (null != searchString && null != database && null != relationOp) {
      ...
      criteria = new NameSearchCriteria(searchString, relationOp, database, useDescription, useScientific, useVernacular, false);
    }
    return criteria;
  }
  ...
  public AbstractSearchCriteria[] getMainSearchCriteriasExtra() {
    ...
    if (null != searchStringExtra && null != relationOpExtra) {
      for (int i = 0; i < searchStringExtra.length; i++) {
        ...
        criterias.addElement(new NameSearchCriteria(searchStringExtra[i], _relationOp, database, useDescription, useScientific, useVernacular, true));
      }
    }
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showLevel", NameBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showCode", NameBean.SHOW.toString()));
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLevel", NameBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showCode", NameBean.SHOW.toString()));
