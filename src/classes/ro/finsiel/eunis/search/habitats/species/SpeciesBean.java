...
public class SpeciesBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (SpeciesSearchCriteria) criterias.get(i);
    return ret;
  }
  ...
  public AbstractSearchCriteria getMainSearchCriteria() {
    ...
    if (null != scientificName && null != relationOp && null != searchAttribute) {
      ...
      System.out.println(SpeciesBean.class.getName() + "::getMainSearchCriteria() will return null result." +
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLevel) url.append(Utilities.writeURLParameter("showLevel", showLevel));
    if (null != showCode) url.append(Utilities.writeURLParameter("showCode", showCode));
    if (null != showScientificName) url.append(Utilities.writeURLParameter("showScientificName", showScientificName));
    if (null != showVernacularName) url.append(Utilities.writeURLParameter("showVernacularName", showVernacularName));
    if (null != database) url.append(Utilities.writeURLParameter("database", database));
    if (null != searchAttribute) url.append(Utilities.writeURLParameter("searchAttribute", searchAttribute));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLevel", SpeciesBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showCode", SpeciesBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", SpeciesBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showVernacularName", SpeciesBean.SHOW.toString()));
    if (null != database) form.append(Utilities.writeFormParameter("database", database.toString()));
    if (null != searchAttribute) form.append(Utilities.writeFormParameter("searchAttribute", searchAttribute));
