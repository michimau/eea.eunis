...
public class SaveSearchCriteria {
  ...
  private void FromWhereMappings() {
    if (null != fromWhereMapping) return;
    ...
    fromWhereMapping.put("habitats-references.jsp", "  Habitat types for which references are selected by author, date, title, editor and publisher ".toUpperCase());
    ...
    fromWhereMapping.put("species-references.jsp", "  Species for which references are selected by author, date, title, editor and publisher ".toUpperCase());
  ...
  public String getStringDescription() {
    ...
    try {
      ...
      if (criteriaSearch != null && criteriaSearch.size() > 0) {
        for (int j = 0; j < criteriaSearch.size(); j++) {
          ...
          if (criteria.getFormFieldAttribute() != null && criteria.getFormFieldAttribute().lastIndexOf(",") != -1) {
            ...
            if (criteria.getAttribute() != null && criteria.getAttribute().equalsIgnoreCase("sourceDB") && criteria.getFirstValue() != null) {
            ...
            if (criteria.getFormFieldAttribute().equalsIgnoreCase("useScientific,useVernacular,useDescription") && criteria.getFirstValue() != null) {
              result += " search will be made by " + criteria.getFirstValue().replaceAll("use", "").replaceAll("=true", "").substring(0, criteria.getFirstValue().replaceAll("use", "").replaceAll("=true", "").length() - 1).replaceAll(",", " and by ") + " name ";
              result += (criteria.getCriteriaBoolean() == null ? " " : " " + criteria.getCriteriaBoolean() + " ");
            }
            continue;
          }
          // Select database from habitats(only to habitats searches)
          if (criteria.getFormFieldAttribute() != null && criteria.getFormFieldAttribute().equalsIgnoreCase("database") && criteria.getFirstValue() != null)
          {
            result += criteria.getAttribute() + " " + criteria.getOperator() + " ";

            if (criteria.getFirstValue().equalsIgnoreCase((String) database.get(0))) result += "EUNIS";
            if (criteria.getFirstValue().equalsIgnoreCase((String) database.get(1))) result += "ANNEX I";
            if (criteria.getFirstValue().equalsIgnoreCase((String) database.get(2))) result += "BOTH";

            result += (criteria.getCriteriaBoolean() == null ? " " : " " + criteria.getCriteriaBoolean() + " ");
            continue;
          }
          // source reference from habitats references (only there)
          if (criteria.getFormFieldAttribute() != null && criteria.getFormFieldAttribute().equalsIgnoreCase("source") && criteria.getFirstValue() != null)
          {
            result += criteria.getAttribute() + " " + criteria.getOperator() + " ";

            if (criteria.getFirstValue().equalsIgnoreCase(RefDomain.SOURCE.toString())) result += "Source information";
            if (criteria.getFirstValue().equalsIgnoreCase(RefDomain.OTHER_INFO.toString())) result += "Other information";
          ...
          if (criteria.getFirstValue() != null &&
                  !criteria.getFirstValue().equalsIgnoreCase("") &&
                  criteria.getAttribute() != null &&
                  !criteria.getAttribute().equalsIgnoreCase(""))
          {
            allStringNull = false;
            ...
            if (criteria.getFormFieldOperator() != null && !criteria.getFormFieldOperator().equalsIgnoreCase(""))
              result += Utilities.prepareHumanString(parseAttributeNameIfNumber(criteria.getAttribute(), fromWhere), criteria.getFirstValue(), criteria.getFirstValue(), criteria.getLastValue(), Utilities.checkedStringToInt(criteria.getOperator(), new Integer(-1)));
            else
            {
              if (criteria.getOperator() != null)
              {
                ...
                {
                  if (criteria.getFormFieldAttribute() != null && criteria.getFormFieldAttribute().lastIndexOf("/") != -1)
                    result += parseAttributeNameIfNumber(criteria.getAttribute(), fromWhere) + " " + criteria.getOperator() + " " + parseFirstValue(criteria.getFormFieldAttribute(), criteria.getFirstValue(), fromWhere) + " / " + criteria.getLastValue();
                  else
                    result += parseAttributeNameIfNumber(criteria.getAttribute(), fromWhere) + " " + criteria.getOperator() + " " + parseFirstValue(criteria.getFormFieldAttribute(), criteria.getFirstValue(), fromWhere);
                } else
                  result += parseAttributeNameIfNumber(criteria.getAttribute(), fromWhere) + " " + criteria.getOperator() + " " + (criteria.getFirstValue() == null || criteria.getFirstValue().trim().length() <= 0 ? "-" : criteria.getFirstValue()) + " and " + (criteria.getLastValue() == null || criteria.getLastValue().trim().length() <= 0 ? "-" : criteria.getLastValue());
              }
            }
            result += (criteria.getCriteriaBoolean() == null ? " " : " " + criteria.getCriteriaBoolean() + " ");
          } else
      ...
      if (allStringNull)
        beginString = "You searched ALL " + (String) fromWhereMapping.get(fromWhere.trim()) + (result.length() > 0 ? " having next information :  " : "");
      else
    ...
    try {
      if (Utilities.checkedStringToInt(attributeName, -1) == -1) {
        ...
        if (fromWhere != null && fromWhere.equalsIgnoreCase("sites-size.jsp")) {
          if (SizeSearchCriteria.SEARCH_AREA.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "area";
          if (SizeSearchCriteria.SEARCH_LENGTH.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "length";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("habitats-species.jsp")) {
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_SCIENTIFIC_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Species scientific name";
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_GROUP.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Group name";
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_LEGAL_INSTRUMENTS.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Legal instrument name";
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Region name";
          if (ro.finsiel.eunis.search.habitats.species.SpeciesSearchCriteria.SEARCH_VERNACULAR.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Vernacular name";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("habitats-sites.jsp")) {
          if (ro.finsiel.eunis.search.habitats.sites.SitesSearchCriteria.SEARCH_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site name";
          if (ro.finsiel.eunis.search.habitats.sites.SitesSearchCriteria.SEARCH_SIZE.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site size";
          if (ro.finsiel.eunis.search.habitats.sites.SitesSearchCriteria.SEARCH_LENGTH.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site length";
          if (ro.finsiel.eunis.search.habitats.sites.SitesSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (ro.finsiel.eunis.search.habitats.sites.SitesSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Biogeographic region name";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("species-habitats.jsp")) {
          if (HabitateSearchCriteria.SEARCH_CODE.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Habitat type code";
          if (HabitateSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (HabitateSearchCriteria.SEARCH_LEGAL_INSTRUMENTS.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Legal instrument name";
          if (HabitateSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Biogeographic region name";
          if (HabitateSearchCriteria.SEARCH_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "English name or description";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("species-sites.jsp")) {
          if (ro.finsiel.eunis.search.species.sites.SitesSearchCriteria.SEARCH_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site name";
          if (ro.finsiel.eunis.search.species.sites.SitesSearchCriteria.SEARCH_SIZE.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site size";
          if (ro.finsiel.eunis.search.species.sites.SitesSearchCriteria.SEARCH_LENGTH.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Site length";
          if (ro.finsiel.eunis.search.species.sites.SitesSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (ro.finsiel.eunis.search.species.sites.SitesSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Biogeographic region name";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("sites-species.jsp")) {
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_SCIENTIFIC_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Species scientific name";
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_GROUP.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Group name";
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_LEGAL_INSTRUMENTS.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Legal instrument name";
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Region name";
          if (ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria.SEARCH_VERNACULAR.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Vernacular name";
        }
        if (fromWhere != null && fromWhere.equalsIgnoreCase("sites-habitats.jsp")) {
          if (HabitatSearchCriteria.SEARCH_CODE.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Habitat type code";
          if (HabitatSearchCriteria.SEARCH_COUNTRY.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Country name";
          if (HabitatSearchCriteria.SEARCH_LEGAL_INSTRUMENTS.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Legal instrument name";
          if (HabitatSearchCriteria.SEARCH_REGION.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "Biogeographic region name";
          if (HabitatSearchCriteria.SEARCH_NAME.intValue() == Utilities.checkedStringToInt(attributeName, -1)) result = "English name or description";
        }
      }
    ...
    try {
      if (fromWhere != null && fromWhere.equalsIgnoreCase("habitats-country.jsp")) {
        if (attributeName != null) {
          ...
          for (int l = 0; l <= 5; l++) result = result.replaceAll(new Integer(l).toString(), "");
        }
      } else
        result = attributeName;
    } catch (Exception e) {
  ...
  private boolean existEunisGroupSearchByCriteriaName() {
    ...
    try {
      ...
      if (criterias != null && criterias.size() > 0) result = true;
    } catch (Exception e) {
      e.printStackTrace();
    }
    return result;
  ...
  private boolean existEunisGroupSearchCriteriaByCriteriaName() {
    ...
    try {
      ...
      if (criterias != null && criterias.size() == numberCriteria) result = true;
    } catch (Exception e) {
      e.printStackTrace();
    }
    return result;
  ...
  public static String getURLForUserNameAndPageName(String userName, String pageName, String criteriaName) {
    ...
    try {
      ...
      List criterias = new CriteriasForUsersDomain().findWhere("USERNAME='" + userName + "' AND FROM_WHERE='" + pageName + "' AND EUNIS_GROUP_SEARCH.CRITERIA_NAME='" + criteriaName + "'");
      if (criterias != null && criterias.size() > 0) {
        for (int i = 0; i < criterias.size(); i++) {
          CriteriasForUsersPersist criteria = (CriteriasForUsersPersist) criterias.get(i);
          String firstValue = java.net.URLEncoder.encode(criteria.getCriteriaFirstValue(),"ISO-8859-1");
          String lastValue = java.net.URLEncoder.encode(criteria.getCriteriaLastValue(),"ISO-8859-1");
          ...
          if (criteria.getCriteriaAttribute() != null &&
                  (criteria.getCriteriaAttribute().equalsIgnoreCase("sourceDB") || criteria.getCriteriaFormFieldAttribute().equalsIgnoreCase("useScientific,useVernacular,useDescription"))) {
            if (criteria.getCriteriaFirstValue() != null && criteria.getCriteriaFirstValue().length() > 0)
              url += "&" + criteria.getCriteriaFirstValue().replace(',', '&').substring(0, criteria.getCriteriaFirstValue().length() - 1);
            continue;
          }
          ...
          if (criteria.getCriteriaFormFieldAttribute() != null &&
            ...
            if (elem != null && elem.size() > 1) {
              if (elem.size() == 2) {
                if (criteria.getCriteriaFirstValue() != null && criteria.getCriteriaLastValue() != null && (!criteria.getCriteriaFirstValue().equalsIgnoreCase("") || !criteria.getCriteriaLastValue().equalsIgnoreCase(""))) {
                  url += "&" + parseAttributeName((String) elem.get(0), pageName) + "=" + firstValue;
                  url += "&" + parseAttributeName((String) elem.get(1), pageName) + "=" + lastValue;
                }
              }
              if (elem.size() == 3) {
                if (criteria.getCriteriaOperator().equalsIgnoreCase(Utilities.OPERATOR_BETWEEN.toString()) || criteria.getCriteriaOperator().trim().equalsIgnoreCase("between")) {
            ...
            if (criteria.getCriteriaAttribute() != null &&
              ...
              if (pageName != null && pageName.equalsIgnoreCase("sites-size.jsp")) url += "&searchType=" + criteria.getCriteriaAttribute();
            }

            //if criteria has relationOp form field
            if (criteria.getCriteriaFormFieldOperator() != null && !criteria.getCriteriaFormFieldOperator().equalsIgnoreCase("")) {
              if (pageName != null && pageName.equalsIgnoreCase("sites-size.jsp"))
                url += "&" + criteria.getCriteriaFormFieldOperator() + "=" + criteria.getCriteriaFormFieldOperator() + criteria.getCriteriaOperator();
              else
          ...
          if (criteria.getCriteriaAttribute() != null &&
                  Utilities.checkedStringToInt(criteria.getCriteriaAttribute(), -1) != -1) {
            if (pageName != null && (pageName.equalsIgnoreCase("habitats-species.jsp")
