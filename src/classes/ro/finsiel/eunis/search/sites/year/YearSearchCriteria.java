...
public class YearSearchCriteria extends SitesSearchCriteria {
  ...
  public String toSQL() {
    ...
    if (((null != searchString) || (null != searchStringMin && null != searchStringMax)) && null != relationOp) {
      if (null != searchString) {
        sql.append(" (CAST(CONCAT(IF(A.source_db='BIOGENETIC',left(designation_date,4),''), " +
        ...
        String condition = "";
        if (relationOp.intValue() == Utilities.OPERATOR_IS.intValue()) condition = "='" + searchString + "'";
        if (relationOp.intValue() == Utilities.OPERATOR_SMALLER_OR_EQUAL.intValue()) condition = "<=" + searchString;
        if (relationOp.intValue() == Utilities.OPERATOR_GREATER_OR_EQUAL.intValue()) condition = ">=" + searchString;
        sql.append(condition + ")");
        sql.append(" AND A.DESIGNATION_DATE IS NOT NULL" +
  ...
  public String toHumanString() {
    ...
    if (((null != searchString) || (null != searchStringMin && null != searchStringMax)) && null != relationOp) {
      if (null != searchString) {
        String condition = "";
        if (relationOp.intValue() == Utilities.OPERATOR_IS.intValue()) condition = "equal with " + searchString;
        if (relationOp.intValue() == Utilities.OPERATOR_SMALLER_OR_EQUAL.intValue()) condition = "before " + searchString;
        if (relationOp.intValue() == Utilities.OPERATOR_GREATER_OR_EQUAL.intValue()) condition = "after " + searchString;
