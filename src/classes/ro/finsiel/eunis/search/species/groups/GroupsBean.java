...
public class GroupsBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (GroupSearchCriteria) criterias.get(i);
    return ret;
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showGroup && showGroup.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showGroup", GroupsBean.SHOW.toString()));
    if (null != showOrder && showOrder.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showOrder", GroupsBean.SHOW.toString()));
    if (null != showFamily && showFamily.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showFamily", GroupsBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", GroupsBean.SHOW.toString()));
    if (null != showVernacularNames && showVernacularNames.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showVernacularNames", GroupsBean.SHOW.toString()));
