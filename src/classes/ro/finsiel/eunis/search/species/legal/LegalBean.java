...
public class LegalBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (LegalSearchCriteria) criterias.get(i);
    return ret;
  }
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLegalText && showLegalText.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showLegalText", AbstractFormBean.SHOW.toString()));
    ...
    if (null != showComment && showComment.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showComment", AbstractFormBean.SHOW.toString()));
    if (null != showAbbreviation && showAbbreviation.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showAbbreviation", AbstractFormBean.SHOW.toString()));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    if (null != showLegalText && showLegalText.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLegalText", AbstractFormBean.SHOW.toString()));
    ...
    if (null != showComment && showComment.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showComment", AbstractFormBean.SHOW.toString()));
    if (null != showAbbreviation && showAbbreviation.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showAbbreviation", AbstractFormBean.SHOW.toString()));
