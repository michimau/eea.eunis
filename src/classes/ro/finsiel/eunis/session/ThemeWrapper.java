...
public class ThemeWrapper implements java.io.Serializable
{
  ...
  {
    return "dark=" + darkColor + ", medium=" + mediumColor + ", light=" + lightColor + ",input=" + inputFieldColor;
  }
  ...
  public boolean equals( final Object other )
  {
    ...
    {
      if ( this.getDarkColor().equalsIgnoreCase( ( ( ThemeWrapper )other ).getDarkColor() ) &&
      this.getMediumColor().equalsIgnoreCase( ( ( ThemeWrapper )other ).getMediumColor() ) &&
      this.getLightColor().equalsIgnoreCase( ( ( ThemeWrapper )other ).getLightColor() ) &&
      this.getHeaderImageName().equalsIgnoreCase( ( ( ThemeWrapper )other ).getHeaderImageName() ) )
      {
        ret = true;
      }
    }
