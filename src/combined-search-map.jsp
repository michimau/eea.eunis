...
<%@ page import="ro.finsiel.eunis.jrfTables.combined.SitesCombinedDomain"%>
<%@ page import="ro.finsiel.eunis.jrfTables.combined.SitesCombinedPersist"%>
...
<%
  ...
  {
    SitesCombinedPersist site = ( SitesCombinedPersist )sites.get( i );
...
<html lang="<%=SessionManager.getCurrentLanguage()%>" xmlns="http://www.w3.org/1999/xhtml" xml:lang="<%=SessionManager.getCurrentLanguage()%>">
  ...
  <body style="margin : 0px; padding : 0px;" >
    ...
    <%=cm.cmsMsg("combined_search-map_title")%>
  </body>
</html>