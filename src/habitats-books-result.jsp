...
<%
  ...
  String location = "home#index.jsp,habitat_types#habitats.jsp,pick_habitat_type_show_references#habitats-books.jsp,results";
  if (results.isEmpty())
  {
                  ...
                  <tr>
                    <td bgcolor="#EEEEEE">
                      <form name="refineSearch" method="get" onsubmit="return(validateRefineForm(<%=noCriteria%>));" action="">
                        ...
                        <input title="<%=cm.cms("search")%>" type="submit" name="Submit" id="Submit" value="<%=cm.cms("search")%>" class="searchButton" />
                        <%=cm.cmsTitle("search")%>
                        <%=cm.cmsInput("search")%>
                      </form>
                    </td>
