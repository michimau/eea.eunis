  ...
  <table summary="layout" border="1" cellpadding="0" cellspacing="0" class="main_menu" width="100%">
    <tr>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/index.jsp" accesskey="1" title="<%=cm.cms("home_page")%>"><%=cm.cmsText("home")%></a><%=cm.cmsTitle("home_page")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/login.jsp" accesskey="l" title="<%=cm.cms("generic_header-static_login_title")%>"><%=cm.cmsText("login")%></a><%=cm.cmsTitle("generic_header-static_login_title")%>
      </td>
      <td style="padding-left : 5px;">
      ...
      <td style="padding-left : 5px;">
        <a href="<%=domain%>/references.jsp" class="menu_link" accesskey="r" title="<%=cm.cms("generic_header-static_references_title")%>"><%=cm.cmsText("references")%></a><%=cm.cmsTitle("generic_header-static_references_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/related-reports.jsp" accesskey="p" title="<%=cm.cms("generic_header-static_reports_title")%>"><%=cm.cmsText("related_reports")%></a><%=cm.cmsTitle("generic_header-static_reports_title")%>
      </td>
    ...
    <tr>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/species.jsp" accesskey="s" title="<%=cm.cms("generic_header-static_species_title")%>"><%=cm.cmsText("species")%></a><%=cm.cmsTitle("generic_header-static_species_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/habitats.jsp" accesskey="h" title="<%=cm.cms("generic_header-static_habitats_title")%>"><%=cm.cmsText("habitats")%></a><%=cm.cmsTitle("generic_header-static_habitats_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/sites.jsp" accesskey="t" title="<%=cm.cms("generic_header-static_sites_title")%>"><%=cm.cmsText("sites")%></a><%=cm.cmsTitle("generic_header-static_sites_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/combined-search.jsp" accesskey="c" title="<%=cm.cms("generic_header-static_combined_title")%>"><%=cm.cmsText("combined_search")%></a><%=cm.cmsTitle("generic_header-static_combined_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/glossary.jsp" accesskey="g" title="<%=cm.cms("generic_header-static_glossary_title")%>"><%=cm.cmsText("glossary")%></a><%=cm.cmsTitle("generic_header-static_glossary_title")%>
      </td>
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/eunis-map.jsp" accesskey="3" title="<%=cm.cms("generic_header-static_sitemap_title")%>"><%=cm.cmsText("web_site_map")%></a><%=cm.cmsTitle("generic_header-static_sitemap_title")%>
      </td>
      <td style="padding-left : 5px;">
      ...
      <td style="padding-left : 5px;">
        <a class="menu_link" href="<%=domain%>/about.jsp" accesskey="b" title="<%=cm.cms("generic_header-static_about_title")%>"><%=cm.cmsText("generic_about_title")%></a><%=cm.cmsTitle("generic_header-static_about_title")%>
      </td>
    </tr>
  </table>
</div>
