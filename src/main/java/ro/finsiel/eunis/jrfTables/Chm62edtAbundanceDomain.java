...
public class Chm62edtAbundanceDomain extends AbstractDomain {
  ...
  public PersistentObject newPersistentObject() {
    return new Chm62edtAbundancePersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_ABUNDANCE", "getIdAbundance", "setIdAbundance", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
