...
public class Chm62edtHabitatReportTypeDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("REPORT_VALUE", "getReportValue", "setReportValue", DEFAULT_TO_NULL));

    JoinTable joinTable = new JoinTable("CHM62EDT_REPORT_TYPE", "ID_REPORT_TYPE", "ID_REPORT_TYPE");
    joinTable.addJoinColumn(new StringJoinColumn("LOOKUP_TYPE", "lookupType", "setLookupType"));
    joinTable.addJoinColumn(new StringJoinColumn("ID_LOOKUP", "IDLookup", "setIDLookup"));
