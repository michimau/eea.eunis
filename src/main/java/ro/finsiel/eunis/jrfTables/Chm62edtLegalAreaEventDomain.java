...
public class Chm62edtLegalAreaEventDomain extends AbstractDomain {
  ...
  public PersistentObject newPersistentObject() {
    return new Chm62edtLegalAreaEventPersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_LEGAL_AREA_EVENT", "getIdLegalAreaEvent", "setIdLegalAreaEvent", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
