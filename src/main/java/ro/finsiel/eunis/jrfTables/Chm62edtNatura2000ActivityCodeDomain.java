...
public class Chm62edtNatura2000ActivityCodeDomain extends AbstractDomain {
  ...
  public PersistentObject newPersistentObject() {
    return new Chm62edtNatura2000ActivityCodePersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("ID_ACTIVITY_CODE", "getIdNatura2000ConservationCode", "setIdNatura2000ConservationCode", DEFAULT_TO_NULL, NATURAL_PRIMARY_KEY));
