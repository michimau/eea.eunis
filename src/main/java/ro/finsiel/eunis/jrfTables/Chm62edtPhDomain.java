...
public class Chm62edtPhDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_PH", "getIdPh", "setIdPh", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
    ...
    this.addColumnSpec(new IntegerColumnSpec("USED", "getIdPh", "setIdPh", DEFAULT_TO_NULL));
  }
}