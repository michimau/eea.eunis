  ...
  public void setup() {
    ...
    this.addColumnSpec(
            new CompoundPrimaryKeyColumnSpec(
                    ...
                    new StringColumnSpec("NAME", "getName", "setName", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY)
            )
    );
    this.addColumnSpec(new StringColumnSpec("TYPE", "getType", "setType", DEFAULT_TO_NULL, REQUIRED));
    this.addColumnSpec(new StringColumnSpec("VALUE", "getValue", "setValue", DEFAULT_TO_NULL, REQUIRED));
  }
}