  ...
  public void setup() {
    ...
    this.addColumnSpec(
            new CompoundPrimaryKeyColumnSpec(
                    ...
                    new IntegerColumnSpec("ID_SOURCE", "getIdSource", "setIdSource", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY)
            )
    );
    ...
    this.addColumnSpec(new StringColumnSpec("GEO_LEVEL", "getGeoLevel", "setGeoLevel", DEFAULT_TO_NULL));
