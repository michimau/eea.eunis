...
public class DesignationsSitesRelatedDesignationsDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("CDDA_SITES", "getCddaSites", "setCddaSites", DEFAULT_TO_NULL));
    ...
    JoinTable J = new JoinTable("CHM62EDT_SITES_RELATED_DESIGNATIONS I", "ID_DESIGNATION", "ID_DESIGNATION");
    J.addJoinColumn(new StringJoinColumn("OVERLAP", "setOverlap"));
    J.addJoinColumn(new StringJoinColumn("OVERLAP_TYPE", "setOverlapType"));
    J.addJoinColumn(new StringJoinColumn("DESIGNATED_SITE", "setDesignatedSite"));
