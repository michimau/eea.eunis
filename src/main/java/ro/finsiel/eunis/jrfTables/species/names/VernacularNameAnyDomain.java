...
//    taxCodeFamily.addJoinTable(taxCodeOrder);
    ...
    reportTypeAttributes = new JoinTable("CHM62EDT_REPORT_ATTRIBUTES I", "ID_REPORT_ATTRIBUTES", "ID_REPORT_ATTRIBUTES");
    reportTypeAttributes.addJoinColumn(new StringJoinColumn("VALUE", "setReportValue"));
