...
public class ReferencesBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria getMainSearchCriteria() {
    ...
    criteria = new ReferencesSearchCriteria(author, relationOpAuthor, date, date1, relationOpDate, title, relationOpTitle, publisher, relationOpPublisher, editor, relationOpEditor, Utilities.checkedStringToInt(this.database, Utilities.EUNIS_HABITAT), Utilities.checkedStringToInt(this.source, RefDomain.SOURCE));
    return criteria;
  }
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    criterias.addElement(new ReferencesSearchCriteria(author, relationOpAuthor, date, date1, relationOpDate, title, relationOpTitle, publisher, relationOpPublisher, editor, relationOpEditor, database, source));
    // Search in results criterias

    if (null != criteriaSearch && null != oper && null != criteriaType) {
      for (int i = 0; i < criteriaSearch.length; i++) {
        Integer _criteriaType = Utilities.checkedStringToInt(criteriaType[i], ReferencesSearchCriteria.CRITERIA_SCIENTIFIC_NAME);
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showLevel", ReferencesBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showCode", ReferencesBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showScientificName", ReferencesBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showVernacularName", ReferencesBean.SHOW.toString()));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLevel", ReferencesBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showCode", ReferencesBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", ReferencesBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showVernacularName", ReferencesBean.SHOW.toString()));
