...
public class ReferencesSearchCriteria extends AbstractSearchCriteria {
  ...
  public String toURLParam() {
    ...
    if (null != source) url.append(Utilities.writeURLParameter("source", source.toString()));
  ...
  public String toFORMParam() {
    ...
    if (null != source) form.append(Utilities.writeFormParameter("source", source.toString()));
