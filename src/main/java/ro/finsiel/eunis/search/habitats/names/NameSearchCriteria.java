...
public class NameSearchCriteria extends AbstractSearchCriteria {
  ...
  public String toURLParam() {
    ...
    if (false != useDescription) url.append(Utilities.writeURLParameter("useDescription", "true"));
    if (false != useScientificName) url.append(Utilities.writeURLParameter("useScientific", "true"));
    if (false != useVernacularName) url.append(Utilities.writeURLParameter("useVernacular", "true"));
    if (null != database) url.append(Utilities.writeURLParameter("database", database.toString()));

    if (!isExtra) {
      if (null != searchString) url.append(Utilities.writeURLParameter("searchString", searchString));
      if (null != relationOp) url.append(Utilities.writeURLParameter("relationOp", relationOp.toString()));
    } else {
      if (null != searchString) url.append(Utilities.writeURLParameter("searchStringExtra", searchString));
      if (null != relationOp) url.append(Utilities.writeURLParameter("relationOpExtra", relationOp.toString()));
    }
    // Search in results
  ...
  public String toSQL() {
    ...
    if (null != searchString && null != relationOp) {
      ...
      if (useScientificName) {
        if (addOROperator) sql.append(" OR ");
  ...
  public String toFORMParam() {
    ...
    if (false != useDescription) form.append(Utilities.writeFormParameter("useDescription", "true"));
    if (false != useScientificName) form.append(Utilities.writeFormParameter("useScientific", "true"));
    if (false != useVernacularName) form.append(Utilities.writeFormParameter("useVernacular", "true"));
    if (null != database) form.append(Utilities.writeFormParameter("database", database.toString()));
    if (!isExtra) {
      if (null != searchString) form.append(Utilities.writeFormParameter("searchString", searchString));
      if (null != relationOp) form.append(Utilities.writeFormParameter("relationOp", relationOp.toString()));
    } else {
      if (null != searchString) form.append(Utilities.writeFormParameter("searchStringExtra", searchString));
      if (null != relationOp) form.append(Utilities.writeFormParameter("relationOpExtra", relationOp.toString()));
    }
    // Search in results
