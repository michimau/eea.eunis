...
public class SitesBean extends AbstractFormBean {
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (SitesSearchCriteria) criterias.get(i);
    return ret;
  }
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showLevel", SitesBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showCode", SitesBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showScientificName", SitesBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showVernacularName", SitesBean.SHOW.toString()));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showLevel && showLevel.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showLevel", SitesBean.SHOW.toString()));
    if (null != showCode && showCode.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showCode", SitesBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", SitesBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showVernacularName", SitesBean.SHOW.toString()));
