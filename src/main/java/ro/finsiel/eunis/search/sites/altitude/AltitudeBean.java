...
public class AltitudeBean extends SitesFormBean {
  ...
  public AbstractSearchCriteria getMainSearchCriteria() {
    ...
    if (null != altitude1 || null != altitude21 || null != altitude31) {
      ...
      criteria = new AltitudeSearchCriteria(altitude1, altitude2, relationOp, altitude21, altitude22, relationOp2, altitude31, altitude32, relationOp3, country);
    }
    return criteria;
  }
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    if (null != altitude1 || null != altitude21 || null != altitude31) {
      ...
      criterias.addElement(new AltitudeSearchCriteria(altitude1, altitude2, relationOp, altitude21, altitude22, relationOp2, altitude31, altitude32, relationOp3, country));
    }
    // Search in results
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (AltitudeSearchCriteria) criterias.get(i);
