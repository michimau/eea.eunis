...
public class DictionarySearchCriteria extends AbstractSearchCriteria {
  ...
  public DictionarySearchCriteria(Integer dictionary, Integer selectOp, String searchValueMin, String searchValueMax) {
    ...
    if (dictionary.intValue() == DictionaryBean.DICT_GROUP) {
      if (selectOp.intValue() == Utilities.OPERATOR_BETWEEN.intValue() || selectOp.intValue() == Utilities.OPERATOR_CONTAINS.intValue()) {
    ...
    if (dictionary.intValue() == DictionaryBean.DICT_NATIONAL_THREAT_STATUS || dictionary.intValue() == DictionaryBean.DICT_INTERNATIONAL_THREAT_STATUS) {
      if (selectOp.intValue() == Utilities.OPERATOR_BETWEEN.intValue()) {
  ...
  public String toURLParam() {
    ...
    if (null != searchValueMin) url.append(Utilities.writeURLParameter("searchValueMin0", "" + searchValueMinOriginal));
    if (null != searchValueMax) url.append(Utilities.writeURLParameter("searchValueMax0", "" + searchValueMaxOriginal));
    // Search in results
  ...
  public String toHumanString() {
    ...
    if (null != dictionary && null != selectOp) {
      ...
      if (0 == selectOp.compareTo(Utilities.OPERATOR_IS)) {
        str.append(Utilities.prepareHumanString(humanDict, "" + dictionary, searchValueMinOriginal, searchValueMaxOriginal, selectOp));
