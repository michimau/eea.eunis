...
public class ReferencesBean extends AbstractFormBean {
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != showGroup && showGroup.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showGroup", NameBean.SHOW.toString()));
    if (null != showOrder && showOrder.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showOrder", NameBean.SHOW.toString()));
    if (null != showFamily && showFamily.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showFamily", NameBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showScientificName", NameBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showVernacularName", NameBean.SHOW.toString()));
    return url.toString();
  }
  ...
  public String toFORMParam(Vector classFields) {
    ...
    // Write columns to be displayed
    if (null != showGroup && showGroup.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showGroup", NameBean.SHOW.toString()));
    if (null != showOrder && showOrder.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showOrder", NameBean.SHOW.toString()));
    if (null != showFamily && showFamily.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showFamily", NameBean.SHOW.toString()));
    if (null != showScientificName && showScientificName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showScientificName", NameBean.SHOW.toString()));
    if (null != showVernacularName && showVernacularName.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showVernacularName", NameBean.SHOW.toString()));
