...
<%
  try
  {
    AbstractTSVReport report = new TSVSpeciesAdvanced(request.getSession().getId(), formBean, SessionManager.getShowEUNISInvalidatedSpecies());
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-species-advanced.jsp" />
    </jsp:include>
<%
    }
    else
