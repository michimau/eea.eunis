<%--
  ...
  - Description : Habitats altitude search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.habitats.TSVHabitatsAdvanced"%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.formBeans.CombinedSearchBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVHabitatsAdvanced(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-habitats-advanced.jsp" />
    </jsp:include>
<%
    }
    else
