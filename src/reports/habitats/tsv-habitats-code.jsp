<%--
  ...
  - Description : Habitat code search tvs.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.habitats.code.TSVHabitatCodeReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
...
<%
  try
  {
    AbstractTSVReport report = new TSVHabitatCodeReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-habitats-code.jsp" />
    </jsp:include>
<%
    }
    else
