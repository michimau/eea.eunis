...
--%>
<%@ page import="ro.finsiel.eunis.reports.sites.TSVSitesAdvanced"%>
...
<%
  try
  {
    AbstractTSVReport report = new TSVSitesAdvanced(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-advanced.jsp" />
    </jsp:include>
<%
    }
    else
