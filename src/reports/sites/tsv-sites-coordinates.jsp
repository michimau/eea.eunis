<%--
  ...
  - Description : Sites coordinates search tsv.
--%>
...
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.coordinates.TSVCoordinatesReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.coordinates.CoordinatesBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVCoordinatesReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-coordinates.jsp" />
    </jsp:include>
<%
    }
    else
