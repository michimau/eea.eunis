<%--
  ...
  - Description : sites country search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.country.TSVCountrySitesReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.country.CountryBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVCountrySitesReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-country.jsp" />
    </jsp:include>
<%
    }
    else
