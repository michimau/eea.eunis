<%--
  ...
  - Description : sites designated search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.designated_codes.TSVDesignatedSitesReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.designation_code.DesignationBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVDesignatedSitesReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-designated-codes.jsp" />
    </jsp:include>
<%
    }
    else
