<%--
  ...
  - Description : Sites designations search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.designations.TSVDesignationsSitesReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.designations.DesignationsBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVDesignationsSitesReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-designations.jsp" />
    </jsp:include>
<%
    }
    else
