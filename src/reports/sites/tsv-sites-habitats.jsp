<%--
  ...
  - Description : Sites habitats search tsv.
--%>
...
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.habitats.TSVHabitatsSitesReport,
...
<%
  try
  {
    ...
    AbstractTSVReport report = new TSVHabitatsSitesReport(request.getSession().getId(), formBean, searchAttribute);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-habitats.jsp" />
    </jsp:include>
<%
    }
    else
