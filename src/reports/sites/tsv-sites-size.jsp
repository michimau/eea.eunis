<%--
  ...
  - Description : Sites size search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.size.TSVSizeReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.size.SizeBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVSizeReport(request.getSession().getId(), formBean);
