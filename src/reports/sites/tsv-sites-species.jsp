<%--
  ...
  - Description : sites species search tsv.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.species.TSVSpeciesSitesReport,
                 ro.finsiel.eunis.search.Utilities,
                 ro.finsiel.eunis.search.sites.species.SpeciesSearchCriteria"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.species.SpeciesBean" scope="request">
...
<%
  try
  {
    ...
    AbstractTSVReport report = new TSVSpeciesSitesReport(request.getSession().getId(), formBean,SessionManager.getShowEUNISInvalidatedSpecies(), searchAttribute);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-species.jsp" />
    </jsp:include>
<%
    }
    else
