<%--
  ...
  - Description : Sites year search tsv.
--%>


<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.sites.year.TSVYearReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
<jsp:useBean id="formBean" class="ro.finsiel.eunis.search.sites.year.YearBean" scope="request">
...
<%
  try
  {
    AbstractTSVReport report = new TSVYearReport(request.getSession().getId(), formBean);
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-sites-year.jsp" />
    </jsp:include>
<%
    }
    else
