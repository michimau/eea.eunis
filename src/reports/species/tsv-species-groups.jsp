<%--
  ...
  - Description : Species group search tvs.
--%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.species.groups.TSVGroupsReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
...
<%
  try
  {
    AbstractTSVReport report = new TSVGroupsReport(request.getSession().getId(), formBean, SessionManager.getShowEUNISInvalidatedSpecies());
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-species-groups.jsp" />
    </jsp:include>
<%
    }
    else
