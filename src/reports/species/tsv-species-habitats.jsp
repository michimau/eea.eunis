<%--
  ...
  - Description : species habitats search tvs.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.species.habitats.TSVSpeciesHabitatsReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
...
<%
  try
  {
    AbstractTSVReport report = new TSVSpeciesHabitatsReport(request.getSession().getId(), formBean, SessionManager.getShowEUNISInvalidatedSpecies());
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-species-habitats.jsp" />
    </jsp:include>
<%
    }
    else
