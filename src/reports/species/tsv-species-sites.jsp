<%--
  ...
  - Description : Species sites search tvs.
--%>
<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport,
                 ro.finsiel.eunis.reports.species.sites.TSVSpeciesSitesReport"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
...
<%
  try
  {
    AbstractTSVReport report= new TSVSpeciesSitesReport(request.getSession().getId(), formBean, SessionManager.getShowEUNISInvalidatedSpecies());
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-species-sites.jsp" />
    </jsp:include>
<%
    }
    else
