<%--
  ...
  - Description : Species national threat status seach tsv.
--%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<%@ page import="ro.finsiel.eunis.reports.AbstractTSVReport"%>
<%@ page import="ro.finsiel.eunis.reports.species.national.TSVSpeciesThreatNational"%><%@ page import="ro.finsiel.eunis.search.Utilities"%>
...
<%
  try
  {
    AbstractTSVReport report = new TSVSpeciesThreatNational(request.getSession().getId(), formBean, SessionManager.getShowEUNISInvalidatedSpecies());
...
%>
    <jsp:include page="../tsv-check-size.jsp">
      ...
      <jsp:param name="page_name" value="tsv-species-threat-national.jsp" />
    </jsp:include>
<%
    }
    else
