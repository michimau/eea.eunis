<%--
  ...
  - Description : "Sites size" function - Map page displaying results of search visually, on image from map server.
--%>
...
<%
  ...
  SizePaginator mapPaginator = new SizePaginator(new SizeDomain(formBean.toSearchCriteria(), formBean.toSortCriteria(), SessionManager.getUsername(), source));
  ...
  {
    SizePersist site = ( SizePersist )sites.get( i );
