...
public class DocumentsActionBean extends AbstractStripesAction {
    ...
    public Resolution defaultAction() {
        ...
        if (!StringUtils.isBlank(iddoc) && EunisUtil.isNumber(iddoc)) {
            ...
            try {
                species = ReferencesDomain.getSpeciesForAReference(iddoc, getContext().getJdbcDriver(), getContext().getJdbcUrl(),
                        getContext().getJdbcUser(), getContext().getJdbcPassword());
				
                habitats = ReferencesDomain.getHabitatsForAReferences(iddoc, getContext().getJdbcDriver(), getContext().getJdbcUrl(),
                        getContext().getJdbcUser(), getContext().getJdbcPassword());
