...
public class BacktrailUtil {
    ...
    public static Vector parseBacktrailString(String backtrail, WebContentManagement cm) {
        ...
        StringTokenizer btTokenizer = new StringTokenizer(backtrail,
                BK_DELIMITER);
        ...
        while (btTokenizer.hasMoreElements()) {
            ...
            StringTokenizer urlTokenizer = new StringTokenizer(btObject,
                    URL_DELIMITER);
            BacktrailObject backtrailObject = new BacktrailObject();

            if (urlTokenizer.hasMoreElements()) {
                backtrailObject.setName(
                        cm.cmsText((String) urlTokenizer.nextElement()));
            }
            if (urlTokenizer.hasMoreElements()) {
                backtrailObject.setUrl((String) urlTokenizer.nextElement());
            }
