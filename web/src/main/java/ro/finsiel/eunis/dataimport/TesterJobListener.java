...
public class TesterJobListener implements JobListener {
    ...
    public void jobWasExecuted(JobExecutionContext context, JobExecutionException exception) {
        ...
        String subject = "EUNIS - information about testing XML file for table "
                + table;
        String body = "";
        ...
        try {
            SendMail.sendMail(email, subject, body, smtpServer, smtpUsername,
                    smtpPassword, smtpSender, null);
        } catch (Exception _ex) {
