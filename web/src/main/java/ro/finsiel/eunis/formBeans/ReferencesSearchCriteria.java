...
public class ReferencesSearchCriteria extends AbstractSearchCriteria {
    ...
    public String toURLParam() {
        ...
        if (null != relationOpAuthor) {
            url.append(
                    Utilities.writeURLParameter("relationOpAuthor",
                    relationOpAuthor.toString()));
        }
        ...
        if (null != relationOpDate) {
            url.append(
                    Utilities.writeURLParameter("relationOpDate",
                    relationOpDate.toString()));
        }
        ...
        if (null != relationOpTitle) {
            url.append(
                    Utilities.writeURLParameter("relationOpTitle",
                    relationOpTitle.toString()));
        }
        ...
        if (null != relationOpEditor) {
            url.append(
                    Utilities.writeURLParameter("relationOpEditor",
                    relationOpEditor.toString()));
        }
        ...
        if (null != relationOpPublisher) {
            url.append(
                    Utilities.writeURLParameter("relationOpPublisher",
                    relationOpPublisher.toString()));
        }

        // Search in results
        if (null != criteriaSearch) {
            url.append(
                    Utilities.writeURLParameter("criteriaSearch", criteriaSearch));
        }
        if (null != criteriaType) {
            url.append(
                    Utilities.writeURLParameter("criteriaType",
    ...
    public String toFORMParam() {
        ...
        if (null != relationOpAuthor) {
            form.append(
                    Utilities.writeFormParameter("relationOpAuthor",
                    relationOpAuthor.toString()));
        }
        if (null != date) {
        ...
        if (null != relationOpDate) {
            form.append(
                    Utilities.writeFormParameter("relationOpDate",
                    relationOpDate.toString()));
        }
        if (null != title) {
        ...
        if (null != relationOpTitle) {
            form.append(
                    Utilities.writeFormParameter("relationOpTitle",
                    relationOpTitle.toString()));
        }
        if (null != editor) {
        ...
        if (null != relationOpEditor) {
            form.append(
                    Utilities.writeFormParameter("relationOpEditor",
                    relationOpEditor.toString()));
        }
        if (null != publisher) {
        ...
        if (null != relationOpPublisher) {
            form.append(
                    Utilities.writeFormParameter("relationOpPublisher",
                    relationOpPublisher.toString()));
        }
        ...
        if (null != criteriaSearch) {
            form.append(
                    Utilities.writeFormParameter("criteriaSearch",
                    criteriaSearch));
        }
        if (null != criteriaType) {
            form.append(
                    Utilities.writeFormParameter("criteriaType",
                    criteriaType.toString()));
        }
        if (null != oper) {
    ...
    public String toHumanString() {
        ...
        if (null != author && null != relationOpAuthor) {
            if (!author.equalsIgnoreCase("")) {
                ...
                sql.append(
                        Utilities.prepareHumanString("Author", author,
                        relationOpAuthor));
            }
        }
        ...
        if (
            ...
            sql.append(
                    Utilities.prepareHumanString("Year",
                    (date == null || date.equalsIgnoreCase("") ? date1 : date),
                    date, date1, relationOpForDate));
        }
        ...
        if (null != title && null != relationOpTitle) {
            if (!title.equalsIgnoreCase("")) {
                ...
                sql.append(
                        Utilities.prepareHumanString("title", title,
                        relationOpTitle));
            }
        }
        ...
        if (null != editor && null != relationOpEditor) {
            if (!editor.equalsIgnoreCase("")) {
                ...
                sql.append(
                        Utilities.prepareHumanString("editor", editor,
                        relationOpEditor));
            }
        }
        ...
        if (null != publisher && null != relationOpPublisher) {
            if (!publisher.equalsIgnoreCase("")) {
                ...
                sql.append(
                        Utilities.prepareHumanString("publisher", publisher,
                        relationOpPublisher));
            }
        }
        ...
        if (null != criteriaSearch && null != criteriaType && null != oper) {
            sql.append(
                    Utilities.prepareHumanString(
                            (String) humanMappings.get(criteriaType),
                            criteriaSearch, oper));
        }
        return sql.toString();
