...
public class Chm62edtHumidityDomain extends AbstractDomain {
  ...
  public PersistentObject newPersistentObject() {
    return new Chm62edtHumidityPersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_HUMIDITY", "getIdHumidity", "setIdHumidity", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
