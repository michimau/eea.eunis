...
public class Chm62edtNatureObjectPictureDomain extends AbstractDomain {
    ...
    public void setup() {
        ...
        this.addColumnSpec(new StringColumnSpec("SOURCE_URL", "getSourceUrl", "setSourceUrl", DEFAULT_TO_NULL));
        this.addColumnSpec(new StringColumnSpec("LICENSE", "getLicense", "setLicense", DEFAULT_TO_EMPTY_STRING));
    }
}
