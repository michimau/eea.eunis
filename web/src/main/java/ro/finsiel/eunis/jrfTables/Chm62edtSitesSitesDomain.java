  ...
  public void setup() {
    ...
    this.addColumnSpec(
            new CompoundPrimaryKeyColumnSpec(
                    ...
                    new StringColumnSpec("RELATION_TYPE", "getRelationType", "setRelationType", DEFAULT_TO_EMPTY_STRING, REQUIRED),
                    new BigDecimalColumnSpec("OVERLAP", "getOverlap", "setOverlap", DEFAULT_TO_ZERO, REQUIRED)
            )
    );
