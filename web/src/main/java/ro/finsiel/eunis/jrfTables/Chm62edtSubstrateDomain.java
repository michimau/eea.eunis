...
public class Chm62edtSubstrateDomain extends AbstractDomain {
  ...
  public PersistentObject newPersistentObject() {
    return new Chm62edtSubstratePersist();
  }
  ...
  public void setup() {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_SUBSTRATE", "getIdSubstrate", "setIdSubstrate", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY));
