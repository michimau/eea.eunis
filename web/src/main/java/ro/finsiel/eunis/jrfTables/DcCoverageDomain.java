    ...
    public void setup() {
        ...
        this.addColumnSpec(
                new CompoundPrimaryKeyColumnSpec(
                        ...
                        new IntegerColumnSpec("ID_COVERAGE", "getIdCoverage",
                        "setIdCoverage", DEFAULT_TO_ZERO, NATURAL_PRIMARY_KEY)));
        this.addColumnSpec(
                new StringColumnSpec("COVERAGE", "getCoverage", "setCoverage",
                DEFAULT_TO_EMPTY_STRING, REQUIRED));
        this.addColumnSpec(
                new StringColumnSpec("SPATIAL", "getSpatial", "setSpatial",
                DEFAULT_TO_NULL));
        this.addColumnSpec(
                new StringColumnSpec("TEMPORAL", "getTemporal", "setTemporal",
                DEFAULT_TO_NULL));
    }
