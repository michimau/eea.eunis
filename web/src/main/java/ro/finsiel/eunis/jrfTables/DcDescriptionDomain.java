    ...
    public void setup() {
        ...
        this.addColumnSpec(
                new CompoundPrimaryKeyColumnSpec(
                        ...
                        new IntegerColumnSpec("ID_DESCRIPTION",
                        "getIdDescription", "setIdDescription", DEFAULT_TO_ZERO,
                        NATURAL_PRIMARY_KEY)));
        this.addColumnSpec(
                new StringColumnSpec("DESCRIPTION", "getDescription",
                "setDescription", DEFAULT_TO_EMPTY_STRING, REQUIRED));
        this.addColumnSpec(
                new StringColumnSpec("TOC", "getToc", "setToc", DEFAULT_TO_NULL));
        this.addColumnSpec(
                new StringColumnSpec("ABSTRACT", "getAbstract", "setAbstract",
                DEFAULT_TO_NULL));
    }
