...
public class SpeciesNatureObjectDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    this.addColumnSpec(new StringColumnSpec("AUTHOR", "getAuthor", "setAuthor", DEFAULT_TO_EMPTY_STRING));
    this.addColumnSpec(new StringColumnSpec("GENUS", "getGenus", "setGenus", DEFAULT_TO_NULL));

    JoinTable natureObject = new JoinTable("CHM62EDT_NATURE_OBJECT", "ID_NATURE_OBJECT", "ID_NATURE_OBJECT");
    natureObject.addJoinColumn(new IntegerJoinColumn("ID_DC", "idDublinCore", "setIdDublinCore"));
