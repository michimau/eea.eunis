...
public class CountryDomain extends AbstractDomain implements Paginable {
   ...
   */
  public CountryDomain(AbstractSearchCriteria[] searchCriteria, AbstractSortCriteria[] sortCriteria, boolean[] source) {
    this.searchCriteria = searchCriteria;
    this.sortCriteria = sortCriteria;
    this.source_db = source;
  }

  public CountryDomain(AbstractSearchCriteria[] searchCriteria, boolean[] source) {
    this.searchCriteria = searchCriteria;
    this.source_db = source;
  }
