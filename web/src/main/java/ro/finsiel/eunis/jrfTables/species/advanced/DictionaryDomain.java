...
public class DictionaryDomain extends AbstractDomain implements Paginable {
    ...
    public void setup() {
        ...
        natureObject = new JoinTable("CHM62EDT_NATURE_OBJECT M",
        ...
        dcSource.addJoinColumn(
                new StringJoinColumn("SOURCE", "source", "setSource"));
        dcSource.addJoinColumn(
                new StringJoinColumn("EDITOR", "editor", "setEditor"));
        dcSource.addJoinColumn(
                new StringJoinColumn("BOOK_TITLE", "bookTitle", "setBookTitle"));
        natureObject.addJoinTable(dcSource);

        JoinTable advSearchResults = new JoinTable(
                "EUNIS_ADVANCED_SEARCH_RESULTS", "ID_NATURE_OBJECT",
                "ID_NATURE_OBJECT");
