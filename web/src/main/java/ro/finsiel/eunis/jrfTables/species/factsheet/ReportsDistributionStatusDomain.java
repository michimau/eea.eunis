...
public class ReportsDistributionStatusDomain extends AbstractDomain {
  ...
  public void setup() {
    ...
    JoinTable joinTableGrid = new JoinTable("CHM62EDT_REPORT_TYPE B", "ID_REPORT_TYPE", "ID_REPORT_TYPE");
    joinTableGrid.addJoinColumn(new StringJoinColumn("LOOKUP_TYPE", "setLookupTypeGrid"));
    joinTableGrid.addJoinColumn(new StringJoinColumn("ID_LOOKUP", "setIdLookupGrid"));
    ...
    JoinTable joinTableDist = new JoinTable("CHM62EDT_REPORT_TYPE D", "ID_REPORT_TYPE", "ID_REPORT_TYPE");
    joinTableDist.addJoinColumn(new StringJoinColumn("LOOKUP_TYPE", "setLookupTypeDist"));
    joinTableDist.addJoinColumn(new StringJoinColumn("ID_LOOKUP", "setIdLookupDist"));
    this.addJoinTable(joinTableDist);

    JoinTable Dist = null;
    Dist = new JoinTable("CHM62EDT_DISTRIBUTION_STATUS E", "ID_LOOKUP", "ID_DISTRIBUTION_STATUS");
