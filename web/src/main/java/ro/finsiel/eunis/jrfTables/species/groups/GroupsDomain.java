...
public final class GroupsDomain extends AbstractDomain implements Paginable
{
  ...
  public void setup()
  {
    ...
    this.addColumnSpec(new IntegerColumnSpec("ID_SPECIES_LINK", "getIdSpeciesLink", "setIdSpeciesLink", DEFAULT_TO_ZERO, REQUIRED));
    ...
    groupSpecies = new JoinTable("CHM62EDT_GROUP_SPECIES D", "ID_GROUP_SPECIES", "ID_GROUP_SPECIES");
    ...
    taxCodeFamily = new OuterJoinTable("CHM62EDT_TAXONOMY B", "ID_TAXONOMY", "ID_TAXONOMY");
...
//    System.out.println( "filterSQL = " + filterSQL );
  ...
  private Long _rawCount() throws CriteriaMissingException
  {
    ...
    // Set the main QUERY
    sql.append("SELECT COUNT(*) FROM CHM62EDT_SPECIES AS A " +
    ...
    sql.append(Utilities.showEUNISInvalidatedSpecies("AND A.VALID_NAME", showEUNISInvalidatedSpecies));
