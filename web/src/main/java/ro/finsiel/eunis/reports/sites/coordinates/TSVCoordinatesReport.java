...
public class TSVCoordinatesReport extends AbstractTSVReport
{
  ...
  public TSVCoordinatesReport(String sessionID, AbstractFormBean formBean)
  {
    ...
    if (null != formBean)
    {
      SourceDb sourceDb = ((CoordinatesBean) formBean).getSourceDb();
      dataFactory = new CoordinatesPaginator(new CoordinatesDomain(formBean.toSearchCriteria(), formBean.toSortCriteria(), "", sourceDb));
