...
public class DictionarySearchCriteria extends AbstractSearchCriteria {
  ...
  public String toURLParam() {
    ...
    if (null != dictionary && null != selectOp) {
      ...
      if (selectOp.intValue() == Utilities.OPERATOR_IS.intValue()) {
        if (null != searchValueMin) url.append(Utilities.writeURLParameter("searchValueMin0", "" + searchValueMin));
        if (null != searchValueMax) url.append(Utilities.writeURLParameter("searchValueMax0", "" + searchValueMax));
      }
      if (selectOp.intValue() == Utilities.OPERATOR_BETWEEN.intValue()) {
        if (null != searchValueMin) url.append(Utilities.writeURLParameter("searchValueMin0", "" + searchValueMinHuman));
        if (null != searchValueMax) url.append(Utilities.writeURLParameter("searchValueMax0", "" + searchValueMaxHuman));
      }
    }
  ...
  public String toHumanString() {
    ...
    if (null != dictionary && null != selectOp) {
      ...
      if (0 == selectOp.compareTo(Utilities.OPERATOR_IS)) {
        ...
        str.append(Utilities.prepareHumanString(humanDict, "" + dictionary, searchValueMinHuman, searchValueMaxHuman, selectOp));
      }
    }
    // Search in results
    if (null != criteriaSearch && null != criteriaType && null != oper) {
