...
public class AltitudeSearchCriteria extends SitesSearchCriteria {
    ...
    public String toSQL() {
        ...
        if (null != country) {
            sql.append(
                    Utilities.prepareSQLOperator((sql.length() > 0 ? " AND " : "") + "J.AREA_NAME_EN", country,
    ...
    public String toHumanString() {
        ...
        if (null != altitude1 && null != relationOp) {
            if (null != altitude2) {
                ret.append(
                        " mean altitude is between <strong>" + altitude1 + "</strong> (m) and <strong>" + altitude2
                        + "</strong> (m)");
            } else {
        ...
        if (null != altitude21 && null != relationOp2) {
            if (null != altitude22) {
                ret.append(
                        (ret.length() > 0 ? " AND " : "") + " minimum altitude is between <strong>" + altitude21
                        + "</strong> (m) and <strong>" + altitude22 + "</strong> (m)");
            } else {
                ret.append(
                        Utilities.prepareHumanString((ret.length() > 0 ? " AND " : "") + " minimum altitude <strong>", altitude21,
                        relationOp2)
                                + "</strong> (m)");
            }
        }
        ...
        if (null != altitude31 && null != relationOp3) {
            if (null != altitude32) {
                ret.append(
                        (ret.length() > 0 ? " AND " : "") + " maximum altitude is between <strong>" + altitude31
                        + "</strong> (m) and <strong>" + altitude32 + "</strong> (m)");
            } else {
                ret.append(
                        Utilities.prepareHumanString((ret.length() > 0 ? " AND " : "") + " maximum altitude <strong>", altitude31,
                        relationOp3)
                                + "</strong> (m)");
            }
        }
        ...
        if (country != null) {
            ret.append((ret.length() > 0 ? " AND " : "") + " country is <strong>" + country + "</strong>");
        }
