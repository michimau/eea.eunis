...
public class NeighborhoodDetailSortCriteria extends AbstractSortCriteria {
    ...
    public NeighborhoodDetailSortCriteria(Integer sortCriteria, Integer ascendency) {
        ...
        possibleSorts.put(SORT_YEAR,
                ...
                + "IF(SOURCE_DB='EMERALD',RIGHT(DESIGNATION_DATE,4),'')," + "IF(SOURCE_DB='DIPLOMA',RIGHT(DESIGNATION_DATE,4),''),"
                + "IF(SOURCE_DB='NATURA2000',RIGHT(DESIGNATION_DATE,4),''),"
                + "IF(SOURCE_DB='CORINE',RIGHT(DESIGNATION_DATE,4),'')," + "IF(SOURCE_DB='NATURENET',RIGHT(DESIGNATION_DATE,4),'')"
                + ")");
    }
}
