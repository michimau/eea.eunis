...
public class SizeBean extends SitesFormBean {
  ...
  public AbstractSearchCriteria getMainSearchCriteria() {
    ...
    if (null != searchString || (null != searchStringMin && null != searchStringMax)) {
      ...
      criteria = new SizeSearchCriteria(_searchType, relationOp, searchString,
              searchStringMin, searchStringMax, country, yearMin, yearMax);
    }
    return criteria;
  }
  ...
  public AbstractSearchCriteria[] toSearchCriteria() {
    ...
    if (null != searchString || (null != searchStringMin && null != searchStringMax)) {
      ...
      SizeSearchCriteria _criteria = new SizeSearchCriteria(_searchType, relationOp, searchString,
              searchStringMin, searchStringMax, country, yearMin, yearMax);
    ...
    for (int i = 0; i < ret.length; i++) ret[i] = (SizeSearchCriteria) criterias.get(i);
  ...
  public AbstractSortCriteria[] toSortCriteria() {
    ...
    for (int i = 0; i < sort.length; i++) {
      SizeSortCriteria criteria = new SizeSortCriteria(
              Utilities.checkedStringToInt(sort[i], SizeSortCriteria.ASCENDENCY_NONE),
