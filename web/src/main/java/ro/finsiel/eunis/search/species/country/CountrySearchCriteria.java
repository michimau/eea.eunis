...
public class CountrySearchCriteria extends AbstractSearchCriteria {
    ...
    public String toSQL() {
        ...
        if (0 == criteriaType.compareTo(CRITERIA_REGION_GEOSCOPE)) {
            if ((countryIDGeoscope.length() > 0) && (regionIDGeoscope.length() > 0)) {
                sql.append(
                        Utilities.prepareSQLOperator((String) sqlMappings.get(CRITERIA_REGION_GEOSCOPE), regionIDGeoscope,
                        Utilities.OPERATOR_IS));
            }
        } else if (0 == criteriaType.compareTo(CRITERIA_COUNTRY_GEOSCOPE)) {
            if ((countryIDGeoscope.length() > 0) && (regionIDGeoscope.length() > 0)) {
                sql.append(
                        Utilities.prepareSQLOperator((String) sqlMappings.get(CRITERIA_COUNTRY_GEOSCOPE), countryIDGeoscope,
                        Utilities.OPERATOR_IS));
            }
    ...
    public String toHumanString() {
        ...
        if (null != countryIDGeoscope && null != regionIDGeoscope && !countryIDGeoscope.equals("") && !regionIDGeoscope.equals("")) {
    ...
    public static void main(String[] args) {
        CountrySearchCriteria criteria = new CountrySearchCriteria("any", Utilities.OPERATOR_STARTS,
                CountrySearchCriteria.CRITERIA_COUNTRY_NAME);
