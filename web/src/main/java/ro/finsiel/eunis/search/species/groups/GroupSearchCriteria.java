...
public final class GroupSearchCriteria extends AbstractSearchCriteria {
    ...
    public String toSQL() {
        ...
        if (null != groupID) {
            sql.append(
                    Utilities.prepareSQLOperator((String) sqlMappings.get(CRITERIA_GROUP), groupID.toString(), Utilities.OPERATOR_IS));
        }
        if (null != criteriaSearch && null != criteriaType && null != oper) {
    ...
    public String toHumanString() {
        ...
        if (null != groupID) {
            human.append(
                    Utilities.prepareHumanString((String) humanMappings.get(CRITERIA_GROUP), groupID.toString(),
