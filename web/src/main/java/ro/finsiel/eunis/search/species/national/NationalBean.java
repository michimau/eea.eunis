...
public class NationalBean extends AbstractFormBean {
    ...
    public AbstractSearchCriteria[] toSearchCriteria() {
        ...
        if (null != criteriaSearch && null != criteriaType && null != oper) {
            for (int i = 0; i < criteriaSearch.length; i++) {
                Integer _criteriaType = Utilities.checkedStringToInt(criteriaType[ i ],
                        NationalSearchCriteria.CRITERIA_SCIENTIFIC_NAME);
        ...
        for (int i = 0; i < ret.length; i++) {
            ret[ i ] = (NationalSearchCriteria) criterias.get(i);
        }
        return ret;
    }
    ...
    public String toURLParam(Vector classFields) {
        ...
        if (null != statusName) {
            url.append(Utilities.writeURLParameter("statusName", statusName));
        }
        if (null != expand) {
    ...
    public String toFORMParam(Vector classFields) {
        ...
        if (null != statusName) {
            form.append(Utilities.writeFormParameter("statusName", statusName));
        }
        if (null != expand) {
        ...
        if (null != showCountry && showCountry.equalsIgnoreCase("true")) {
            form.append(Utilities.writeFormParameter("showCountry", AbstractFormBean.SHOW.toString()));
        }
    ...
    /**
     * Setter for showCountry.
     *
     * @param showCountry New value
     */
    ...
    /**
     * Setter for showStatus.
     *
     * @param showStatus New value
     */
