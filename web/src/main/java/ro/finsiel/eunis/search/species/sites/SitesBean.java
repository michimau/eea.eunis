...
public class SitesBean extends AbstractFormBean {
  ...
  public String toURLParam(Vector classFields) {
    ...
    if (null != relationOp) url.append(Utilities.writeURLParameter("relationOp", relationOp));
    ...
    if (null != showSites && showSites.equalsIgnoreCase("true")) url.append(Utilities.writeURLParameter("showSites", AbstractFormBean.SHOW.toString()));
  ...
  public String toFORMParam(Vector classFields) {
    ...
    if (null != showSites && showSites.equalsIgnoreCase("true")) form.append(Utilities.writeFormParameter("showSites", AbstractFormBean.SHOW.toString()));
