...
public class ThemeManager implements Serializable {
     ...
     * Define blue theme.
     */
    public static final ThemeWrapper SKY_BLUE = new ThemeWrapper("#006CAD",
            "#6DABD0", "#B8D6E8", "banner_blue.jpg", "#E4F4F4");

    /**
     * Define orange theme.
     */
    public static final ThemeWrapper FRESH_ORANGE = new ThemeWrapper("#DC6E02",
            "#DC8202", "#FFD790", "banner_orange.jpg", "#FFECCB");

    /**
     * Define green theme.
     */
    public static final ThemeWrapper NATURE_GREEN = new ThemeWrapper("#066028",
            "#378253", "#7CD4A9", "banner_green.jpg", "#C8FFE4");

    /**
     * Define cherry theme.
     */
    public static final ThemeWrapper CHERRY = new ThemeWrapper("#7F0016",
            "#AA3247", "#E593AB", "banner_cherry.jpg", "#FFE4EC");

    /**
     * Define high contrast theme.
     */
    public static final ThemeWrapper BLACKWHITE = new ThemeWrapper("#000000",
            "#000000", "#000000", "banner_blue.jpg", "#FFFFFF");
    ...
    public void switchTheme(final int themeIndex) {
        ...
        case THEME_SKY_BLUE:
            ...
            sessionManager.getUserPrefs().setThemeIndex(
                    new Integer(THEME_SKY_BLUE));
            break;

        case THEME_FRESH_ORANGE:
            currentTheme = FRESH_ORANGE;
            sessionManager.getUserPrefs().setThemeIndex(
                    new Integer(THEME_FRESH_ORANGE));
            break;

        case THEME_NATURE_GREEN:
            currentTheme = NATURE_GREEN;
            sessionManager.getUserPrefs().setThemeIndex(
                    new Integer(THEME_NATURE_GREEN));
            break;

        case THEME_CHERRY:
            currentTheme = CHERRY;
            sessionManager.getUserPrefs().setThemeIndex(
                    new Integer(THEME_CHERRY));
            break;

        case THEME_BLACKWHITE:
            currentTheme = BLACKWHITE;
            sessionManager.getUserPrefs().setThemeIndex(
                    new Integer(THEME_BLACKWHITE));
            break;
