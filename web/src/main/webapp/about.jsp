        ...
        <div class="eea-accordion-panels non-exclusive collapsed-by-default">
            ...
            <div class="eea-accordion-panel" style="clear: both;" id="rdf-accordion">
                ...
                <div class="pane">
                    ...
                    <ul>
                        <li><a href="/rdf/biogeoregions.rdf.gz">Biogeographical regions</a> - from Natura 2000 reporting</li>
                        <li><a href="/rdf/countries.rdf.gz">Countries</a></li>
                        <li><a href="/rdf/countrybiogeo.rdf.gz">Links between countries and biogeographical regions</a></li>
                        <li><a href="/rdf/designations.rdf.gz">Designations of sites</a></li>
                        <li><a href="/rdf/eunishabitats.rdf.gz">Habitat types</a> - Only EUNIS - not Habitats Directive</li>
                        <li><a href="/rdf/geoscope.rdf.gz">Geographical scopes</a></li>
                        <li><a href="/rdf/habitats.rdf.gz">Habitat types</a> - The EUNIS Habitat types classification is a comprehensive pan-European system to facilitate the harmonised description and collection of data across Europe through the use of criteria for habitat identification; it covers all types of habitats from natural to artificial, from terrestrial to freshwater and marine.</li>
                        <li><a href="/rdf/images.rdf.gz">Images and associated metadata</a></li>
                        <li><a href="/rdf/legalrefs.rdf.gz">Legislation references</a></li>
                        <li><a href="/rdf/references.rdf.gz">References to sources</a></li>
                        <li><a href="/rdf/regioncoverage.rdf.gz">Region coverage of protected sites</a></li>
                        <li><a href="/rdf/sites.rdf.gz">Protected sites</a></li>
                        <li><a href="/rdf/species.rdf.gz">Species</a></li>
                        <li><a href="/rdf/speciesgroup.rdf.gz">Species groups</a></li>
                        <li><a href="/rdf/taxonomy.rdf.gz">Higher (family and up) taxonomies</a></li>
                    </ul>
                </div>
            </div>
        </div>
