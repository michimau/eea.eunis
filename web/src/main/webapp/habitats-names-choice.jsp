  ...
  <table summary="<%=cm.cms("list_of_values_for")%>" border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse" width="100%">
    ...
    <tr>
      <td bgcolor="<%=(0 == (i++ % 2)) ? "#EEEEEE" : "#FFFFFF"%>">
        <a title="<%=cm.cmsPhrase("Click link to select the value")%>" href="javascript:setLine('<%=Utilities.treatURLSpecialCharacters(habitat.getScientificName())%>');"><%=habitat.getScientificName()%></a>
      </td>
    </tr>
    <%
      }
