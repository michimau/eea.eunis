...
function composeParameterListForSaveCriteria(
    expand,
    validationForm,
    pageName,
    numberCriteria,
  ...
  if(validationForm)
  {
    ...
    if (attributesNames !=null && attributesNames.length>0)
    {
      for(i=0;i<attributesNames.length;i++)
      {
        ...
        {
          if ( trim(pageName) == "sites-size.jsp" )
          {
            URL2 = URL2 + '&_' + i + 'attributesNames' + '=' + trim( document.forms[formName].elements["searchType"].value );
          }
          else if (trim(pageName) == "habitats-species.jsp"
                       ...
                       || trim(pageName) == "sites-habitats.jsp")
          {
            URL2= URL2 + '&_' + i + 'attributesNames' + '=' + trim( document.forms[formName].elements["searchAttribute"].value );
          }
          else
          {
      ...
      for(i=0;i<formFieldAttributes.length;i++)
      {
        URL2= URL2 + '&_' + i + 'formFieldAttributes' + '=' + formFieldAttributes[i];
        formFieldAttributes[i];
      }
      for(i=0;i<formFieldOperators.length;i++)
      {
        URL2= URL2 + '&_' + i + 'formFieldOperators' + '=' + formFieldOperators[i];
      }
      for(i=0;i<booleans.length;i++)
      {
          URL2= URL2 + '&_' + i + 'booleans' + '=' + booleans[i];
      }
      for(i=0;i<attributesNames.length;i++)
      {
        ...
        if(formFieldAttributes[i].indexOf("/")==-1 && formFieldAttributes[i].indexOf(",")==-1)
        {
          ...
          {  //if attribute name is source like in habitats references search(only there)
            ...
            {
              if (document.forms[formName].elements[formFieldAttributes[i]][0].checked == true)
              {
                URL2= URL2 + '&_' + i + 'firstValues='+source1; //source
              }
              if (document.forms[formName].elements[formFieldAttributes[i]][1].checked == true)
              {
                URL2= URL2 + '&_' + i + 'firstValues='+source2; //other information
              }
            }
            else
            {
              ...
              else
              {
                ...
                {
                  URL2= URL2 + '&_' + i + 'firstValues=' + trim( document.forms[formName].elements[formFieldAttributes[i]].value );
                }
                else
                {
                  URL2= URL2 + '&_' + i + 'firstValues=';
                }
              }
            }
          }
        ...
        if(formFieldAttributes[i].indexOf("/") != -1)
        {
          ...
          if(elementsArray !=null && elementsArray.length>1)
          {
            ...
            if (document.forms[formName].elements[elementsArray[0]] !=null )
              firstVal = trim( document.forms[formName].elements[elementsArray[0]].value );
            if(elementsArray.length==3)
            {
              ...
              {
                 lastVal = trim( document.forms[formName].elements[elementsArray[2]].value );
                 if (document.forms[formName].elements[elementsArray[1]] !=null )
                   firstVal = trim( document.forms[formName].elements[elementsArray[1]].value );
              }
            }
            if(elementsArray.length==2)
            {  //like date/date2 from habitats-references search
               if(document.forms[formName].elements[elementsArray[1]] != null) lastVal = trim( document.forms[formName].elements[elementsArray[1]].value );
            }
        ...
        {
          val = trim( document.forms[formName].elements[formFieldOperators[i]].value );
          if(isValueNumber(val)) { URL2= URL2 + '&_' + i + 'operators=' + val; }
          else
          {
            URL2= URL2 + '&_' + i + 'operators=' + val.substring(val.length-1);
          }
        }
        else
        {
          URL2= URL2 + '&_' + i + 'operators='+operators[i];
        }
     }
   }
