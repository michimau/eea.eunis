...
<%
 ...
 // Check columns to be displayed
  ...
  String tsvLink = "javascript:openTSVDownload('reports/sites/tsv-sites-altitude.jsp?" + formBean.toURLParam(reportFields) + "')";
...
%>
<c:set var="title" value='<%= application.getInitParameter("PAGE_TITLE") + cm.cms("sites_altitude-result_title") %>'></c:set>
