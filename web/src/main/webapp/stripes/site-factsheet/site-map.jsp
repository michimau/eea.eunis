...
<div class="left-area protected-sites-map">
    <c:if test="${not actionBean.typeDiploma}">
        <img src="http://fme.discomap.eea.europa.eu/fmedatastreaming/ArcGisOnline/getStaticImage.fmw?webmap=0b2680c2bc544431a9a97119aa63d707&amp;width=480&amp;height=400&amp;SiteCode=${actionBean.idsite}" style="width: 480px; height: 400px;">
