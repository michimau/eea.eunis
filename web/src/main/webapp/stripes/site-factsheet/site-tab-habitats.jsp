...
<stripes:layout-definition>
	...
	%>
	  ...
	  <table summary="<%=cm.cms("sites_factsheet_114")%>" class="listing fullwidth table-inline">
	    <thead>
	      <tr>
	...
	%>
	  ...
	  <table summary="<%=cm.cms("sites_factsheet_166")%>" class="listing fullwidth  table-inline">
	    <thead>
	      <tr>
	        <th scope="col">
	...
	%>
	  ...
	  <table summary="<%=cm.cms("ecological_information_habitats_within_site")%>" class="listing fullwidth  table-inline">
	    <thead>
	      <tr>
	        <th style="text-align: left;">
	          <%=cm.cmsPhrase("Habitat type english name")%>
	...
	%>
	  ...
	  <table summary="<%=cm.cms("habitat_type_not_eunis")%>" class="listing fullwidth  table-inline">
	    <thead>
	      <tr>
	        <th style="text-align: left;">
