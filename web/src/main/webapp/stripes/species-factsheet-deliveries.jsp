...
<stripes:layout-definition>
	...
	<c:choose>
        <c:when test="${not empty actionBean.deliveries && not empty actionBean.deliveries.rows}">
            <display:table name="${actionBean.deliveries.rows}" class="listing fullwidth" defaultsort="3" defaultorder="descending" pagesize="30" sort="list" id="listItem" htmlId="listItem" requestURI="/species/${actionBean.idSpecies}/${actionBean.tab}" decorator="eionet.eunis.util.decorators.DeliveriesTableDecorator">
